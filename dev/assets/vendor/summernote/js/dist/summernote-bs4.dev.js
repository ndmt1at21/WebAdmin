...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof(module)) === 'object') module.exports = factory(require("jQuery"));else if (typeof define === 'function' && define.amd) define(["jQuery"], factory);else {
  ...
  return (
    ...
    /******/
    {
      ...
      /***/
      function _(module, __webpack_exports__, __webpack_require__) {
        "use strict"; // EXTERNAL MODULE: external "jQuery"

        var external_jQuery_ = __webpack_require__(0);

        var external_jQuery_default =
        /*#__PURE__*/
        __webpack_require__.n(external_jQuery_); // CONCATENATED MODULE: ./src/js/base/summernote-en-US.js
        ...
        function validFontName(fontName) {
          return external_jQuery_default.a.inArray(fontName.toLowerCase(), genericFontFamilies) === -1 ? "'".concat(fontName, "'") : fontName;
        }
        ...
        function () {
          ...
          _createClass(Context_Context, [{
            ...
            value: function _initialize() {
              ...
              var buttons = external_jQuery_default.a.extend({}, this.options.buttons);
              Object.keys(buttons).forEach(function (key) {
                _this.memo('button.' + key, buttons[key]);
              });
              var modules = external_jQuery_default.a.extend({}, this.options.modules, external_jQuery_default.a.summernote.plugins || {}); // add and initialize modules
        ...
        external_jQuery_default.a.fn.extend({
          ...
          summernote: function summernote() {
            var type = external_jQuery_default.a.type(lists.head(arguments));
            var isExternalAPICalled = type === 'string';
            var hasInitOptions = type === 'object';
            var options = external_jQuery_default.a.extend({}, external_jQuery_default.a.summernote.options, hasInitOptions ? lists.head(arguments) : {}); // Update options
        ...
        function readFileAsDataURL(file) {
          return external_jQuery_default.a.Deferred(function (deferred) {
          ...
          _createClass(Style_Style, [{
            ...
            value: function jQueryCSS($obj, propertyNames) {
              if (env.jqueryVersion < 1.9) {
                var result = {};
                external_jQuery_default.a.each(propertyNames, function (idx, propertyName) {
            ...
            value: function styleNodes(rng, options) {
              ...
              if (expandClosestSibling) {
                ...
                return nodes.map(function (node) {
                  ...
                  external_jQuery_default.a.each(tails, function (idx, elem) {
        ...
        function () {
          ...
          _createClass(Bullet_Bullet, [{
            ...
            value: function indent(editable) {
              ...
              external_jQuery_default.a.each(clustereds, function (idx, paras) {
                ...
                if (dom.isLi(head)) {
                  ...
                  external_jQuery_default.a.each(paras, function (idx, para) {
            ...
            value: function toggleList(listName, editable) {
              ...
              if (lists.find(paras, dom.isPurePara)) {
                ...
                if (diffLists.length) {
                  external_jQuery_default.a.each(diffLists, function (idx, listNode) {
            ...
            value: function releaseList(clustereds, isEscapseToBody) {
              ...
              external_jQuery_default.a.each(clustereds, function (idx, paras) {
                ...
                if (headList.parentNode.nodeName === 'LI') {
                  ...
                  external_jQuery_default.a.each(lists.from(paras).reverse(), function (idx, para) {
                    dom.insertAfter(para, headList);
                  }); // remove empty lists

                  var rootLists = lists.compact([headList, middleList, lastList]);
                  external_jQuery_default.a.each(rootLists, function (idx, rootList) {
                    var listNodes = [rootList].concat(dom.listDescendant(rootList, dom.isList));
                    external_jQuery_default.a.each(listNodes.reverse(), function (idx, listNode) {
              ...
              if (splitRoot) {
                ...
                if (dom.isLi(splitRoot) && (dom.isEmpty(splitRoot) || dom.deepestChildIsEmpty(splitRoot))) {
                  ...
                  if (blockquote) {
                    ...
                    external_jQuery_default.a.each(emptyAnchors, function (idx, anchor) {
                      dom.remove(anchor);
        ...
        */
        ...
        function () {
          function Editor_Editor(context) {
            ...
            this.fontSize = this.wrapCommand(function (value) {
              return _this9.fontStyling('font-size', value + 'px');
            });
            ...
            this.insertNode = this.wrapCommand(function (node) {
              if (_this9.isLimited(external_jQuery_default()(node).text().length)) {
                return;
              }
            ...
            this.createLink = this.wrapCommand(function (linkInfo) {
              ...
              external_jQuery_default.a.each(anchors, function (idx, anchor) {
            ...
            this.removeMedia = this.wrapCommand(function () {
              var $target = external_jQuery_default()(_this9.restoreTarget()).parent();

              if ($target.parent('figure').length) {
                $target.parent('figure').remove();
              } else {
                $target = external_jQuery_default()(_this9.restoreTarget()).detach();
              }
            ...
            this.floatMe = this.wrapCommand(function (value) {
              var $target = external_jQuery_default()(_this9.restoreTarget());
            ...
            */
            ...
            value: function insertImage(src, param) {
              ...
              return createImage(src, param).then(function ($image) {
                ...
                $image.show();
                range.create(_this11.editable).insertNode($image[0]);
                range.createFromNodeAfter($image[0]).select();

                _this11.setLastRange();
            ...
            value: function insertImagesAsDataURL(files) {
              ...
              external_jQuery_default.a.each(files, function (idx, file) {
            ...
            value: function attachDragAndDropEvent() {
              ...
              this.$dropzone.on('drop', function (event) {
                ...
                if (dataTransfer && dataTransfer.files && dataTransfer.files.length) {
                  ...
                  external_jQuery_default.a.each(dataTransfer.types, function (idx, type) {
          ...
          _createClass(AutoLink_AutoLink, [{
            ...
            value: function replace() {
              ...
              if (match && (match[1] || match[2])) {
                ...
                var node = external_jQuery_default()('<a />').html(keyword).attr('href', link)[0];
        ...
        function () {
          ...
          _createClass(Buttons_Buttons, [{
              ...
              return this.ui.buttonGroup({
                ...
                children: [this.button({
                  ...
                  click: function click(event) {
                    event.stopPropagation();
                    var $parent = external_jQuery_default()('.' + className);
            ...
            value: function addToolbarButtons() {
              ...
              this.context.memo('button.fontname', function () {
                ...
                if (_this26.options.addDefaultFonts) {
                  ...
                  external_jQuery_default.a.each(styleInfo['font-family'].split(','), function (idx, fontname) {
            ...
            value: function updateBtnStates($container, infos) {
              ...
              external_jQuery_default.a.each(infos, function (selector, pred) {
        ...
        function () {
          ...
          _createClass(VideoDialog_VideoDialog, [{
            ...
            value: function initialize() {
              var $container = this.options.dialogsInBody ? this.$body : this.$editor;
              var body = ['<div class="form-group note-form-group row-fluid">', "<label class=\"note-form-label\">".concat(this.lang.video.url, " <small class=\"text-muted\">").concat(this.lang.video.providers, "</small></label>"), '<input class="note-video-url form-control note-form-control note-input" type="text" />', '</div>'].join('');
          ...
          _createClass(HelpDialog_HelpDialog, [{
            ...
            value: function createShortcutList() {
              ...
              return Object.keys(keyMap).map(function (key) {
                ...
                var $row = external_jQuery_default()('<div><div class="help-list-item"/></div>');
                $row.append(external_jQuery_default()('<label><kbd>' + key + '</kdb></label>').css({
                  'width': 180,
                  'margin-right': 10
                })).append(external_jQuery_default()('<span/>').html(_this42.context.memo('help.' + command) || command));
                return $row.html();
              }).join('');
            }
            /**
          ...
          function AirPopover_AirPopover(context) {
            ...
            this.events = {
              ...
              'summernote.focusout': function summernoteFocusout(we, e) {
                ...
                if (!e.relatedTarget || !dom.ancestor(e.relatedTarget, func.eq(_this45.$popover[0]))) {
                  _this45.hide();
                }
              }
            };
        ...
        function () {
          function HintPopover_HintPopover(context) {
            ...
            this.events = {
              'summernote.keyup': function summernoteKeyup(we, e) {
                if (!e.isDefaultPrevented()) {
                  _this46.handleKeyup(e);
                }
              },
              'summernote.keydown': function summernoteKeydown(we, e) {
                _this46.handleKeydown(e);
              },
              'summernote.disable summernote.dialog.shown': function summernoteDisableSummernoteDialogShown() {
                _this46.hide();
              }
          ...
          _createClass(HintPopover_HintPopover, [{
            ...
            value: function initialize() {
              ...
              this.$content.on('click', '.note-hint-item', function (e) {
                _this47.$content.find('.active').removeClass('active');
            ...
            value: function createItemTemplates(hintIdx, items) {
              ...
              return items.map(function (item, idx) {
                var $item = external_jQuery_default()('<div class="note-hint-item"/>');
            ...
            value: function createGroup(idx, keyword) {
              ...
              var $group = external_jQuery_default()('<div class="note-hint-group note-hint-group-' + idx + '"/>');
              this.searchKeyword(idx, keyword, function (items) {
                items = items || [];

                if (items.length) {
                  $group.html(_this48.createItemTemplates(idx, items));
                  ...
                  if (bnd) {
                    ...
                    this.hints.forEach(function (hint, idx) {
                      if (hint.match.test(keyword)) {
                        _this49.createGroup(idx, keyword).appendTo(_this49.$content);
                      }
      ...
      function _(module, __webpack_exports__, __webpack_require__) {
        ...
        var external_jQuery_default =
        /*#__PURE__*/
        __webpack_require__.n(external_jQuery_); // EXTERNAL MODULE: ./src/js/base/renderer.js
        ...
        /* default */
        ].create('<textarea class="note-codable" role="textbox" aria-multiline="true"/>');
        ...
        /* default */
        ].create(['<output class="note-status-output" aria-live="polite"/>', '<div class="note-statusbar" role="status">', '  <output class="note-status-output" aria-live="polite"></output>', '  <div class="note-resizebar" role="seperator" aria-orientation="horizontal" aria-label="Resize">', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '  </div>', '</div>'].join(''));
        var airEditor = renderer["a"
        /* default */
        ].create('<div class="note-editor"/>');
        var airEditable = renderer["a"
        /* default */
        ].create(['<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"/>', '<output class="note-status-output" aria-live="polite"/>'].join(''));
        ...
        /* default */
        ].create('<div class="modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
          if (options.fade) {
            $node.addClass('fade');
          }
        ...
        var ui = {
          ...
          button: function button($node, options) {
            return renderer["a"
            /* default */
            ].create('<button type="button" class="note-btn btn btn-light btn-sm" role="button" tabindex="-1">', function ($node, options) {
