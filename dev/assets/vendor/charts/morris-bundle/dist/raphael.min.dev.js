...
!function (t, e) {
  ...
  return function (t) {
    ...
    i = [r(3)], void 0 === (n = function (t) {
      ...
      var yt = e.pathBBox = function (t) {
        ...
        if (h) T = h[0], M = h[1], C = h[2], A = h[3];else {
          ...
          var b = r * r,
              ...
              C = k * r * y / i + (t + o) / 2,
              A = k * -i * x / r + (e + l) / 2,
              T = _2.asin(((e - A) / i).toFixed(9)),
              M = _2.asin(((l - A) / i).toFixed(9));
        ...
        if (B(E) > c) {
          var N = M,
              L = o,
              P = l;
          M = T + c * (s && M > T ? 1 : -1), o = C + r * _2.cos(M), l = A + i * _2.sin(M), d = Bt(o, l, r, i, n, 0, s, L, P, [M, N, C, A]);
        }
        ...
        for (var G = [], H = 0, X = (d = [V, Y, W][f](d).join()[v](",")).length; H < X; H++) {
        ...
        return null == h ? dt(t, r, i, n, a, s, o, l) : e.findDotsAtSegment(t, r, i, n, a, s, o, l, function (t, e, r, i, n, a, s, o, l) {
          if (!(l < 0 || dt(t, e, r, i, n, a, s, o) < l)) {
            ...
            for (h = dt(t, e, r, i, n, a, s, o, c); B(h - l) > .01;) {
              u /= 2, h = dt(t, e, r, i, n, a, s, o, c += (h < l ? 1 : -1) * u);
            }
      ...
      var oe,
        ...
        if (this.items = [], this.length = 0, this.type = "set", t) for (var e = 0, r = t.length; e < r; e++) {
          !t[e] || t[e].constructor != Yt.constructor && t[e].constructor != he || (this[this.items.length] = this.items[this.items.length] = t[e], this.length++);
        }
      },
          ue = he.prototype;
      ...
      for (var ce in ue.push = function () {
        for (var t, e, r = 0, i = arguments.length; r < i; r++) {
          !(t = arguments[r]) || t.constructor != Yt.constructor && t.constructor != he || (this[e = this.items.length] = this.items[e] = t, this.length++);
        }
      ...
      return ue.attr = function (t, r) {
        if (t && e.is(t, T) && e.is(t[0], "object")) for (var i = 0, n = t.length; i < n; i++) {
    ...
    }, void 0 !== t && t.exports ? t.exports = _x : void 0 === (i = function () {
      return _x;
    }.apply(e, [])) || (t.exports = i);
  }, function (t, e, r) {
    var i, n;
