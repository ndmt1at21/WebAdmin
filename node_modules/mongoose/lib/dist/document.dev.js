...
var documentIsSelected = require('./helpers/symbols').documentIsSelected;
  ...
  if (pathType === 'nested' && val) {
    if (_typeof(val) === 'object' && val != null) {
      ...
      if (this.$__.savedState != null && !this.isNew && !this.$__.savedState.hasOwnProperty(path)) {
        ...
        var _keys4 = Object.keys(this.$__.savedState[path]);

        for (var _i7 = 0, _keys5 = _keys4; _i7 < _keys5.length; _i7++) {
          var _key = _keys5[_i7];
          this.$__.savedState[path + '.' + _key] = this.$__.savedState[path][_key];
        }
      }
        ...
        for (var _i14 = 0; _i14 < len; ++_i14) {
          if (list.indexOf(path + '.' + _i14) === -1) {
            ...
            if (cur[_i14] != null && cur[_i14].$__) {
              ...
              try {
                for (var _iterator8 = modified[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
                  var childPath = _step8.value;
...
function _getPathsToValidate(doc) {
  ...
  try {
    for (var _iterator9 = subdocs[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
      var subdoc = _step9.value;
  ...
  try {
    for (var _iterator12 = paths[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
      ...
      try {
        for (var _iterator14 = _val.keys()[Symbol.iterator](), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
...
Document.prototype.$__validate = function (pathsToValidate, options, callback) {
  ...
  var validatePath = function validatePath(path) {
    ...
    process.nextTick(function () {
      var schemaType = _this.schema.path(path);
...
function _handlePathsToValidate(paths, pathsToValidate) {
  ...
  try {
    for (var _iterator15 = pathsToValidate[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
  ...
  try {
    for (var _iterator16 = paths[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
      var _path2 = _step16.value;

      if (_pathsToValidate.has(_path2)) {
        ret.push(_path2);
      } else if (parentPaths.has(_path2)) {
        ret.push(parentPaths.get(_path2));
      }
    }
  } catch (err) {
...
Document.prototype.$__undoReset = function $__undoReset() {
  ...
  try {
    for (var _iterator17 = this.$__dirty()[Symbol.iterator](), _step17; !(_iteratorNormalCompletion17 = (_step17 = _iterator17.next()).done); _iteratorNormalCompletion17 = true) {
      var dirt = _step17.value;
      var type = dirt.value;
  ...
  try {
    for (var _iterator18 = this.$__getAllSubdocs()[Symbol.iterator](), _step18; !(_iteratorNormalCompletion18 = (_step18 = _iterator18.next()).done); _iteratorNormalCompletion18 = true) {
      var subdoc = _step18.value;
      subdoc.$__undoReset();
    }
  } catch (err) {
...
function applyQueue(doc) {
  ...
  try {
    for (var _iterator19 = q[Symbol.iterator](), _step19; !(_iteratorNormalCompletion19 = (_step19 = _iterator19.next()).done); _iteratorNormalCompletion19 = true) {
...
Document.prototype.populate = function populate() {
  ...
  if (args.length) {
    ...
    try {
      for (var _iterator20 = res[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
        var populateOptions = _step20.value;
...
Document.prototype.depopulate = function (path) {
  ...
  if (arguments.length === 0) {
    ...
    try {
      for (var _iterator21 = virtualKeys[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
        var virtualKey = _step21.value;
