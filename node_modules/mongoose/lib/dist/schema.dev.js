...
var setupTimestamps = require('./helpers/timestamps/setupTimestamps');
...
Schema.prototype.clone = function () {
  ...
  var Constructor = this.base == null ? Schema : this.base.Schema;
  ...
  for (var _i = 0, _keys = keys; _i < _keys.length; _i++) {
    ...
    if (!(utils.isPOJO(obj[key]) || obj[key] instanceof SchemaTypeOptions)) {
      ...
      if (!this.options.typePojoToMixed && utils.isPOJO(obj[key][this.options.typeKey])) {
        ...
        var _schema = new Schema(obj[key][this.options.typeKey], opts);

        var schemaWrappedPath = Object.assign({}, obj[key], _defineProperty({}, this.options.typeKey, _schema));
...
Schema.prototype.path = function (path, obj) {
  ...
  if (schemaType.$isSingleNested) {
    ...
    for (var _key3 in schemaType.schema.nested) {
      this.singleNestedPaths[path + '.' + _key3] = 'nested';
    }
  ...
  if (schemaType.$isMongooseDocumentArray) {
    for (var _i3 = 0, _Object$keys = Object.keys(schemaType.schema.paths); _i3 < _Object$keys.length; _i3++) {
      var _key4 = _Object$keys[_i3];
      this.subpaths[path + '.' + _key4] = schemaType.schema.paths[_key4];
      schemaType.schema.paths[_key4].$isUnderneathDocArray = true;
    }

    for (var _i4 = 0, _Object$keys2 = Object.keys(schemaType.schema.subpaths); _i4 < _Object$keys2.length; _i4++) {
      var _key5 = _Object$keys2[_i4];
      this.subpaths[path + '.' + _key5] = schemaType.schema.subpaths[_key5];
      schemaType.schema.subpaths[_key5].$isUnderneathDocArray = true;
    }

    for (var _i5 = 0, _Object$keys3 = Object.keys(schemaType.schema.singleNestedPaths); _i5 < _Object$keys3.length; _i5++) {
      var _key6 = _Object$keys3[_i5];

      if (_typeof(schemaType.schema.singleNestedPaths[cleanPath]) !== 'object') {
        continue;
      }

      this.subpaths[path + '.' + _key6] = schemaType.schema.singleNestedPaths[_key6];
      schemaType.schema.singleNestedPaths[_key6].$isUnderneathDocArray = true;
    }
  }
...
function gatherChildSchemas(schema) {
  ...
  for (var _i6 = 0, _Object$keys4 = Object.keys(schema.paths); _i6 < _Object$keys4.length; _i6++) {
    var path = _Object$keys4[_i6];
...
function getMapPath(schema, path) {
  for (var _i7 = 0, _Object$keys5 = Object.keys(schema.paths); _i7 < _Object$keys5.length; _i7++) {
    var _path = _Object$keys5[_i7];
...
Schema.prototype.pre = function (name) {
  if (name instanceof RegExp) {
    ...
    try {
      for (var _iterator5 = hookNames[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
        var fn = _step5.value;
  ...
  if (Array.isArray(name)) {
    ...
    try {
      for (var _iterator6 = name[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
        var el = _step6.value;
...
Schema.prototype.post = function (name) {
  if (name instanceof RegExp) {
    ...
    try {
      for (var _iterator7 = hookNames[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
        var fn = _step7.value;
  ...
  if (Array.isArray(name)) {
    ...
    try {
      for (var _iterator8 = name[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        var el = _step8.value;
  ...
  if (Array.isArray(path)) {
    path.forEach(function (name) {
      ...
      if (this.nested[name]) {
        ...
        try {
          for (var _iterator10 = allKeys[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
...
function _deletePath(schema, name) {
  ...
  try {
    for (var _iterator11 = pieces[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
    ...
    while (p--) {
      ...
      if (foundschema) {
        ...
        if (foundschema.caster) {
          ...
          var _ret2 = search(parts.slice(p + 1), foundschema.$__schemaType.schema);
