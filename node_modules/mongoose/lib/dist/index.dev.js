...
var trackTransaction = require('./plugins/trackTransaction');
...
Mongoose.prototype.connect = function (uri, options, callback) {
  ...
  return _mongoose._promiseOrCallback(callback, function (cb) {
    conn.openUri(uri, options, function (err) {
      if (err != null) {
        return cb(err);
      }
...
Mongoose.prototype.model = function (name, schema, collection, skipInit) {
  ...
  var overwriteModels = _mongoose.options.hasOwnProperty('overwriteModels') ? _mongoose.options.overwriteModels : options.overwriteModels;
