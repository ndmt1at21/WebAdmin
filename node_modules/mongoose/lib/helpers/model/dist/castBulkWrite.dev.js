...
module.exports = function castBulkWrite(originalModel, op, options) {
  var now = originalModel.base.now();

  if (op['insertOne']) {
    return function (callback) {
      var model = decideModelByObject(originalModel, op['insertOne']['document']);
    ...
    return function (callback) {
      try {
        ...
        var model = decideModelByObject(originalModel, op['updateOne']['filter']);
        var schema = model.schema;
        var strict = options.strict != null ? options.strict : model.schema.options.strict;
    ...
    return function (callback) {
      try {
        ...
        var model = decideModelByObject(originalModel, op['updateMany']['filter']);
        var schema = model.schema;
        var strict = options.strict != null ? options.strict : model.schema.options.strict;
    ...
    return function (callback) {
      var model = decideModelByObject(originalModel, op['replaceOne']['filter']);
      var schema = model.schema;
      var strict = options.strict != null ? options.strict : model.schema.options.strict;
      ...
      var doc = new model(op['replaceOne']['replacement'], strict, true);
    ...
    return function (callback) {
      var model = decideModelByObject(originalModel, op['deleteOne']['filter']);
      var schema = model.schema;
    ...
    return function (callback) {
      var model = decideModelByObject(originalModel, op['deleteMany']['filter']);
      var schema = model.schema;
