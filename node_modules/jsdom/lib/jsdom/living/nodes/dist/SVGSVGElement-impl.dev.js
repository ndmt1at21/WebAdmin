...
var SVGSVGElementImpl =
/*#__PURE__*/
function (_SVGGraphicsElementIm) {
  _inherits(SVGSVGElementImpl, _SVGGraphicsElementIm);

  function SVGSVGElementImpl(args, privateData) {
    var _this;

    _classCallCheck(this, SVGSVGElementImpl);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SVGSVGElementImpl).call(this, args, privateData));
