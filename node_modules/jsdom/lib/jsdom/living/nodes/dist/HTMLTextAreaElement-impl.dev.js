...
function (_HTMLElementImpl) {
  ...
  function HTMLTextAreaElementImpl(args, privateData) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(HTMLTextAreaElementImpl).call(this, args, privateData));
    _this._rawValue = "";
      ...
      if (!this._validity) {
        this._validity = ValidityState.createImpl(this, {
          valueMissing: function valueMissing() {
            return _this2.hasAttributeNS(null, "required") && _this2.value === "";
          }
        });
      }
