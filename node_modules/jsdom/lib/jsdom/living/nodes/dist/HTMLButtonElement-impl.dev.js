...
function (_HTMLElementImpl) {
  ...
  function HTMLButtonElementImpl(args, privateData) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(HTMLButtonElementImpl).call(this, args, privateData));
  ...
  _createClass(HTMLButtonElementImpl, [{
    ...
    key: "type",
    get: function get() {
      var typeAttr = (this.getAttributeNS(null, "type") || "").toLowerCase();
