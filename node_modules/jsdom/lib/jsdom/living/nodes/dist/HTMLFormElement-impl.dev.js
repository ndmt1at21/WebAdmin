...
var _require = require("../helpers/traversal"),
    descendantsByLocalNames = _require.descendantsByLocalNames;
...
var _require4 = require("../../utils"),
    reflectURLAttribute = _require4.reflectURLAttribute; // http://www.whatwg.org/specs/web-apps/current-work/#category-listed


var listedElements = new Set(["button", "fieldset", "input", "keygen", "object", "output", "select", "textarea"]); // https://html.spec.whatwg.org/multipage/forms.html#category-submit
    ...
    get: function get() {
      ...
      return HTMLCollection.createImpl([], {
        ...
        query: function query() {
          return descendantsByLocalNames(_this, listedElements);
        }
      });
    }
  }, {
