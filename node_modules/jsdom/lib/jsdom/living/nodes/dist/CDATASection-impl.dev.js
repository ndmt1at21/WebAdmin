...
/*#__PURE__*/
function (_TextImpl) {
  _inherits(CDATASectionImpl, _TextImpl);

  function CDATASectionImpl(args, privateData) {
    var _this;

    _classCallCheck(this, CDATASectionImpl);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CDATASectionImpl).call(this, args, privateData));
