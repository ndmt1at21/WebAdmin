...
var _require4 = require("../../browser/parser"),
    parseIntoDocument = _require4.parseIntoDocument;

var _require5 = require("../helpers/document-base-url"),
    documentBaseURL = _require5.documentBaseURL;

var _require6 = require("../helpers/events"),
    fireAnEvent = _require6.fireAnEvent;

var _require7 = require("../attributes"),
    getAttributeValue = _require7.getAttributeValue;
