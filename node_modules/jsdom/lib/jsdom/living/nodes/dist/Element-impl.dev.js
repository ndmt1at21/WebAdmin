...
function (_NodeImpl) {
  ...
  _createClass(ElementImpl, [{
    ...
    value: function setAttributeNS(namespace, name, value) {
      var extracted = validateNames.validateAndExtract(namespace, name); // Because of widespread use of this method internally, e.g. to manually implement attribute/content reflection, we
    ...
    value: function attachShadow(init) {
      ...
      var shadow = ShadowRoot.createImpl([], {
