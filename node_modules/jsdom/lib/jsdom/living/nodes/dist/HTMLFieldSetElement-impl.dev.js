...
function (_HTMLElementImpl) {
  ...
  function HTMLFieldSetElementImpl(args, privateData) {
    var _this;

    _classCallCheck(this, HTMLFieldSetElementImpl);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(HTMLFieldSetElementImpl).call(this, args, privateData));
