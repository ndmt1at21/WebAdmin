...
module.exports = function (core) {
  for (var _i = 0, _Object$keys = Object.keys(mappings); _i < _Object$keys.length; _i++) {
    var ns = _Object$keys[_i];
    var interfaces = mappings[ns];
    DocumentImpl.implementation.prototype._elementBuilders[ns] = Object.create(null);

    var _loop = function _loop() {
      var interfaceName = _Object$keys2[_i2];
      var _interfaces$interface = interfaces[interfaceName],
          file = _interfaces$interface.file,
          tags = _interfaces$interface.tags;
      ...
      try {
        for (var _iterator = tags[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          DocumentImpl.implementation.prototype._elementBuilders[ns][tagName] = function (document, localName, namespace) {
    ...
    for (var _i2 = 0, _Object$keys2 = Object.keys(interfaces); _i2 < _Object$keys2.length; _i2++) {
      _loop();
    }
  }
};