...
function (_HTMLElement$interfac) {
  _inherits(HTMLFieldSetElement, _HTMLElement$interfac);
  ...
  _createClass(HTMLFieldSetElement, [{
    ...
    get: function get() {
      ...
      return utils.getSameObject(this, "elements", function () {
        return utils.tryWrapperForImpl(_this2[impl]["elements"]);
      });
    }
  }, {
    key: "willValidate",
    ...
    get: function get() {
      ...
      return utils.getSameObject(this, "validity", function () {
        return utils.tryWrapperForImpl(_this3[impl]["validity"]);
      });
    }
  }, {
...
Object.defineProperties(HTMLFieldSetElement.prototype, _defineProperty({
  checkValidity: {
    enumerable: true
  },
  reportValidity: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'HTMLFieldSetElement'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLFieldSetElement.prototype);
...
var Impl = require("../nodes/HTMLFieldSetElement-impl.js");