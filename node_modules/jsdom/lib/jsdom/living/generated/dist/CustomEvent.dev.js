...
var convertCustomEventInit = require("./CustomEventInit.js").convert;
...
function (_Event$interface) {
  _inherits(CustomEvent, _Event$interface);
  ...
  function CustomEvent(type) {
    ...
    }
    {
      ...
      _curArg = convertCustomEventInit(_curArg, {
        context: "Failed to construct 'CustomEvent': parameter 2"
      });
      args.push(_curArg);
    }
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof CustomEvent ? this.constructor : void 0).prototype), args));
  }
  ...
  _createClass(CustomEvent, [{
    ...
    value: function initCustomEvent(type) {
      ...
      return (_this$impl = this[impl]).initCustomEvent.apply(_this$impl, args);
    }
  }, {
    key: "detail",
    get: function get() {
...
var iface = {
  ...
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(CustomEvent.prototype);
