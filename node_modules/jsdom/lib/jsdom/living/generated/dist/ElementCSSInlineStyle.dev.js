...
function () {
  function ElementCSSInlineStyle() {
    _classCallCheck(this, ElementCSSInlineStyle);

    throw new TypeError("Illegal constructor");
  }

  _createClass(ElementCSSInlineStyle, [{
    key: "style",
    get: function get() {
      var _this = this;
      ...
      return utils.getSameObject(this, "style", function () {
        return utils.tryWrapperForImpl(_this[impl]["style"]);
      });
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
...
Object.defineProperties(ElementCSSInlineStyle.prototype, _defineProperty({
  style: {
    enumerable: true
  }
}, Symbol.toStringTag, {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'ElementCSSInlineStyle'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(ElementCSSInlineStyle.prototype);
...
var Impl = require("../nodes/ElementCSSInlineStyle-impl.js");