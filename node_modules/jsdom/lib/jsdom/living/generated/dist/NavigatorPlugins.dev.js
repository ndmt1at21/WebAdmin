...
var NavigatorPlugins =
/*#__PURE__*/
function () {
  function NavigatorPlugins() {
    _classCallCheck(this, NavigatorPlugins);

    throw new TypeError("Illegal constructor");
  }

  _createClass(NavigatorPlugins, [{
    key: "javaEnabled",
...
Object.defineProperties(NavigatorPlugins.prototype, _defineProperty({
  javaEnabled: {
    enumerable: true
  },
  plugins: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'NavigatorPlugins'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(NavigatorPlugins.prototype);
...
var Impl = require("../navigator/NavigatorPlugins-impl.js");