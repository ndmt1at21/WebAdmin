...
function (_HTMLElement$interfac) {
  _inherits(HTMLMetaElement, _HTMLElement$interfac);
  ...
  _createClass(HTMLMetaElement, [{
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "http-equiv");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "content");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "scheme");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
...
var iface = {
  ...
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLMetaElement.prototype);
