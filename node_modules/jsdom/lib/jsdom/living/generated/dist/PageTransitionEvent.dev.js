...
var convertPageTransitionEventInit = require("./PageTransitionEventInit.js").convert;
...
function (_Event$interface) {
  _inherits(PageTransitionEvent, _Event$interface);

  function PageTransitionEvent(type) {
    var _this;

    _classCallCheck(this, PageTransitionEvent);
    ...
    }
    {
      ...
      _curArg = convertPageTransitionEventInit(_curArg, {
        context: "Failed to construct 'PageTransitionEvent': parameter 2"
      });
      args.push(_curArg);
    }
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof PageTransitionEvent ? this.constructor : void 0).prototype), args));
  }

  _createClass(PageTransitionEvent, [{
    key: "persisted",
    get: function get() {
...
Object.defineProperties(PageTransitionEvent.prototype, _defineProperty({
  persisted: {
    enumerable: true
  }
}, Symbol.toStringTag, {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'PageTransitionEvent'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(PageTransitionEvent.prototype);
...
var Impl = require("../events/PageTransitionEvent-impl.js");