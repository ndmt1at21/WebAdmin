...
module.exports = {
  createInterface: function createInterface() {
    ...
    function () {
      function AbortController() {
        ...
        return iface.setup(Object.create((this instanceof AbortController ? this.constructor : void 0).prototype));
      }
      ...
      _createClass(AbortController, [{
        ...
        get: function get() {
          ...
          return utils.getSameObject(this, "signal", function () {
            return utils.tryWrapperForImpl(_this[impl]["signal"]);
          });
        }
      }]);
    ...
    Object.defineProperties(AbortController.prototype, _defineProperty({
      abort: {
        enumerable: true
      },
      signal: {
    ...
    var iface = {
      create: function create(constructorArgs, privateData) {
        var obj = Object.create(AbortController.prototype);
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'AbortController'."));
  }
}; // module.exports

var Impl = require("../aborting/AbortController-impl.js");