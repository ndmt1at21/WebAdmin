...
var convertPopStateEventInit = require("./PopStateEventInit.js").convert;
...
function (_Event$interface) {
  _inherits(PopStateEvent, _Event$interface);
  ...
  function PopStateEvent(type) {
    ...
    }
    {
      ...
      _curArg = convertPopStateEventInit(_curArg, {
        context: "Failed to construct 'PopStateEvent': parameter 2"
      });
      args.push(_curArg);
    }
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof PopStateEvent ? this.constructor : void 0).prototype), args));
  }
...
var iface = {
  ...
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(PopStateEvent.prototype);
