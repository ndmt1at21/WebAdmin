...
function (_HTMLElement$interfac) {
  _inherits(HTMLTrackElement, _HTMLElement$interfac);
  ...
  _createClass(HTMLTrackElement, [{
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "kind");
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "srclang");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
...
var iface = {
  ...
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLTrackElement.prototype);
