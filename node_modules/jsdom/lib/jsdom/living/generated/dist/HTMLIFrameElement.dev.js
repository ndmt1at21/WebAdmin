...
function (_HTMLElement$interfac) {
  _inherits(HTMLIFrameElement, _HTMLElement$interfac);
  ...
  _createClass(HTMLIFrameElement, [{
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "srcdoc");
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "height");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "scrolling");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "frameborder");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "marginheight");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "marginwidth");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
...
var iface = {
  ...
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLIFrameElement.prototype);
...
var Impl = require("../nodes/HTMLIFrameElement-impl.js");