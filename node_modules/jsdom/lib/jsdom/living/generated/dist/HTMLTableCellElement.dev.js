...
function (_HTMLElement$interfac) {
  ...
  _createClass(HTMLTableCellElement, [{
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "headers");
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "abbr");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "axis");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "bgcolor");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
...
var Impl = require("../nodes/HTMLTableCellElement-impl.js");