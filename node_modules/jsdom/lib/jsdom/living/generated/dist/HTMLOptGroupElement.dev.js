...
function (_HTMLElement$interfac) {
  _inherits(HTMLOptGroupElement, _HTMLElement$interfac);

  function HTMLOptGroupElement() {
    var _this;

    _classCallCheck(this, HTMLOptGroupElement);

    throw new TypeError("Illegal constructor");
    return _possibleConstructorReturn(_this);
  }

  _createClass(HTMLOptGroupElement, [{
    key: "disabled",
    get: function get() {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "label");
...
Object.defineProperties(HTMLOptGroupElement.prototype, _defineProperty({
  disabled: {
    enumerable: true
  },
  label: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'HTMLOptGroupElement'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLOptGroupElement.prototype);
...
var Impl = require("../nodes/HTMLOptGroupElement-impl.js");