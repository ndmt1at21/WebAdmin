...
function () {
  ...
  _createClass(DOMTokenList, [{
    ...
    value: function item(index) {
      ...
      return (_this$impl = this[impl]).item.apply(_this$impl, args);
    }
  }, {
    key: "contains",
    value: function contains(token) {
      ...
      return (_this$impl2 = this[impl]).contains.apply(_this$impl2, args);
    }
  }, {
    key: "add",
    value: function add() {
    ...
    value: function toggle(token) {
      ...
      return (_this$impl5 = this[impl]).toggle.apply(_this$impl5, args);
    }
  }, {
    key: "replace",
    value: function replace(token, newToken) {
      ...
      return (_this$impl6 = this[impl]).replace.apply(_this$impl6, args);
    }
  }, {
    key: "supports",
    value: function supports(token) {
      ...
      return (_this$impl7 = this[impl]).supports.apply(_this$impl7, args);
    }
  }, {
    key: "toString",
...
var Impl = require("../nodes/DOMTokenList-impl.js");