...
function () {
  function NonElementParentNode() {
    _classCallCheck(this, NonElementParentNode);

    throw new TypeError("Illegal constructor");
  }

  _createClass(NonElementParentNode, [{
    key: "getElementById",
...
Object.defineProperties(NonElementParentNode.prototype, _defineProperty({
  getElementById: {
    enumerable: true
  }
}, Symbol.toStringTag, {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'NonElementParentNode'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(NonElementParentNode.prototype);
...
var Impl = require("../nodes/NonElementParentNode-impl.js");