...
function (_HTMLElement$interfac) {
  _inherits(HTMLPreElement, _HTMLElement$interfac);

  function HTMLPreElement() {
    var _this;

    _classCallCheck(this, HTMLPreElement);

    throw new TypeError("Illegal constructor");
    return _possibleConstructorReturn(_this);
  }

  _createClass(HTMLPreElement, [{
    key: "width",
    get: function get() {
...
Object.defineProperties(HTMLPreElement.prototype, _defineProperty({
  width: {
    enumerable: true
  }
}, Symbol.toStringTag, {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'HTMLPreElement'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLPreElement.prototype);
...
var Impl = require("../nodes/HTMLPreElement-impl.js");