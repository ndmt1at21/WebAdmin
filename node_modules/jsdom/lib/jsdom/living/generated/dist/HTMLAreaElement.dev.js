...
var HTMLHyperlinkElementUtils = require("./HTMLHyperlinkElementUtils.js");

var HTMLAreaElement =
/*#__PURE__*/
function (_HTMLElement$interfac) {
  _inherits(HTMLAreaElement, _HTMLElement$interfac);

  function HTMLAreaElement() {
    var _this;

    _classCallCheck(this, HTMLAreaElement);

    throw new TypeError("Illegal constructor");
    return _possibleConstructorReturn(_this);
  }

  _createClass(HTMLAreaElement, [{
    key: "toString",
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "alt");
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "coords");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "shape");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "target");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "rel");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
...
Object.defineProperties(HTMLAreaElement.prototype, _defineProperty({
  alt: {
    enumerable: true
  },
  coords: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'HTMLAreaElement'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLAreaElement.prototype);
...
var Impl = require("../nodes/HTMLAreaElement-impl.js");