...
var convertInputEventInit = require("./InputEventInit.js").convert;
...
function (_UIEvent$interface) {
  _inherits(InputEvent, _UIEvent$interface);
  ...
  function InputEvent(type) {
    ...
    }
    {
      ...
      _curArg = convertInputEventInit(_curArg, {
        context: "Failed to construct 'InputEvent': parameter 2"
      });
      args.push(_curArg);
    }
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof InputEvent ? this.constructor : void 0).prototype), args));
  }
...
var iface = {
  ...
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(InputEvent.prototype);
