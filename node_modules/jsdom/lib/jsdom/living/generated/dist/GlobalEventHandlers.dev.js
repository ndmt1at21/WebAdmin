...
function () {
  function GlobalEventHandlers() {
    _classCallCheck(this, GlobalEventHandlers);

    throw new TypeError("Illegal constructor");
  }

  _createClass(GlobalEventHandlers, [{
    key: "onabort",
    get: function get() {
...
Object.defineProperties(GlobalEventHandlers.prototype, _defineProperty({
  onabort: {
    enumerable: true
  },
  onauxclick: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'GlobalEventHandlers'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(GlobalEventHandlers.prototype);
...
var Impl = require("../nodes/GlobalEventHandlers-impl.js");