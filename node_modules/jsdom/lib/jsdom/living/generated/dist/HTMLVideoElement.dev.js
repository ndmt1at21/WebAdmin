...
/*#__PURE__*/
function (_HTMLMediaElement$int) {
  _inherits(HTMLVideoElement, _HTMLMediaElement$int);
  ...
  _createClass(HTMLVideoElement, [{
    ...
    get: function get() {
      ...
      var value = parseInt(this.getAttributeNS(null, "width"));
    ...
    get: function get() {
      ...
      var value = parseInt(this.getAttributeNS(null, "height"));
      return isNaN(value) || value < 0 || value > 2147483647 ? 0 : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
...
Object.defineProperties(HTMLVideoElement.prototype, _defineProperty({
  width: {
    enumerable: true
  },
  height: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'HTMLVideoElement'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLVideoElement.prototype);
...
var Impl = require("../nodes/HTMLVideoElement-impl.js");