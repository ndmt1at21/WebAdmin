...
var convertTouchEventInit = require("./TouchEventInit.js").convert;
...
function (_UIEvent$interface) {
  _inherits(TouchEvent, _UIEvent$interface);
  ...
  function TouchEvent(type) {
    ...
    }
    {
      ...
      _curArg = convertTouchEventInit(_curArg, {
        context: "Failed to construct 'TouchEvent': parameter 2"
      });
      args.push(_curArg);
    }
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof TouchEvent ? this.constructor : void 0).prototype), args));
  }
...
var iface = {
  ...
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(TouchEvent.prototype);
...
var Impl = require("../events/TouchEvent-impl.js");