...
var convertWheelEventInit = require("./WheelEventInit.js").convert;
...
var WheelEvent =
/*#__PURE__*/
function (_MouseEvent$interface) {
  _inherits(WheelEvent, _MouseEvent$interface);
  ...
  function WheelEvent(type) {
    ...
    }
    {
      ...
      _curArg = convertWheelEventInit(_curArg, {
        context: "Failed to construct 'WheelEvent': parameter 2"
      });
      args.push(_curArg);
    }
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof WheelEvent ? this.constructor : void 0).prototype), args));
  }
...
var iface = {
  ...
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(WheelEvent.prototype);
...
var Impl = require("../events/WheelEvent-impl.js");