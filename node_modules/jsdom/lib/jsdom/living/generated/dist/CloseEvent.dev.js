...
var convertCloseEventInit = require("./CloseEventInit.js").convert;
...
function (_Event$interface) {
  _inherits(CloseEvent, _Event$interface);
  ...
  function CloseEvent(type) {
    ...
    }
    {
      ...
      _curArg = convertCloseEventInit(_curArg, {
        context: "Failed to construct 'CloseEvent': parameter 2"
      });
      args.push(_curArg);
    }
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof CloseEvent ? this.constructor : void 0).prototype), args));
  }
...
Object.defineProperties(CloseEvent.prototype, _defineProperty({
  wasClean: {
    enumerable: true
  },
  code: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'CloseEvent'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(CloseEvent.prototype);
...
var Impl = require("../events/CloseEvent-impl.js");