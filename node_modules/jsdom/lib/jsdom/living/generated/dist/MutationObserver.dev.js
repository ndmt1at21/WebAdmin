...
var convertMutationObserverInit = require("./MutationObserverInit.js").convert;
...
function () {
  function MutationObserver(callback) {
    ...
    return iface.setup(Object.create((this instanceof MutationObserver ? this.constructor : void 0).prototype), args);
  }
  ...
  _createClass(MutationObserver, [{
    ...
    value: function observe(target) {
      ...
      }
      {
        ...
        _curArg = convertMutationObserverInit(_curArg, {
          context: "Failed to execute 'observe' on 'MutationObserver': parameter 2"
        });
        args.push(_curArg);
      }
      return (_this$impl = this[impl]).observe.apply(_this$impl, args);
    }
  }, {
    key: "disconnect",
...
Object.defineProperties(MutationObserver.prototype, _defineProperty({
  observe: {
    enumerable: true
  },
  disconnect: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'MutationObserver'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(MutationObserver.prototype);
...
var Impl = require("../mutation-observer/MutationObserver-impl.js");