...
function (_HTMLElement$interfac) {
  _inherits(HTMLTableColElement, _HTMLElement$interfac);
  ...
  _createClass(HTMLTableColElement, [{
    key: "span",
    get: function get() {
      ...
      var value = parseInt(this.getAttributeNS(null, "span"));
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "align");
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "char");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "charoff");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "valign");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "width");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
...
Object.defineProperties(HTMLTableColElement.prototype, _defineProperty({
  span: {
    enumerable: true
  },
  align: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'HTMLTableColElement'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLTableColElement.prototype);
...
var Impl = require("../nodes/HTMLTableColElement-impl.js");