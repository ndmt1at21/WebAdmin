...
function (_Event$interface) {
  _inherits(ErrorEvent, _Event$interface);
  ...
  function ErrorEvent(type) {
    ...
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof ErrorEvent ? this.constructor : void 0).prototype), args));
  }
