...
function (_CharacterData$interf) {
  _inherits(Comment, _CharacterData$interf);
  ...
  function Comment() {
    ...
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof Comment ? this.constructor : void 0).prototype), args));
  }
