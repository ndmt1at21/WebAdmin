...
function (_HTMLElement$interfac) {
  _inherits(HTMLBodyElement, _HTMLElement$interfac);
  ...
  _createClass(HTMLBodyElement, [{
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "text");
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "link");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "vlink");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "alink");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
    ...
    get: function get() {
      ...
      var value = this.getAttributeNS(null, "background");
      return value === null ? "" : value;
    },
    set: function set(V) {
      if (!this || !module.exports.is(this)) {
...
var iface = {
  ...
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLBodyElement.prototype);
