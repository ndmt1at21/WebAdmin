...
function (_HTMLElement$interfac) {
  _inherits(HTMLLegendElement, _HTMLElement$interfac);

  function HTMLLegendElement() {
    var _this;

    _classCallCheck(this, HTMLLegendElement);

    throw new TypeError("Illegal constructor");
    return _possibleConstructorReturn(_this);
  }

  _createClass(HTMLLegendElement, [{
    key: "form",
    get: function get() {
...
Object.defineProperties(HTMLLegendElement.prototype, _defineProperty({
  form: {
    enumerable: true
  },
  align: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'HTMLLegendElement'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(HTMLLegendElement.prototype);
...
var Impl = require("../nodes/HTMLLegendElement-impl.js");