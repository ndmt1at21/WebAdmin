...
function () {
  function DOMParser() {
    ...
    return iface.setup(Object.create((this instanceof DOMParser ? this.constructor : void 0).prototype));
  }

  _createClass(DOMParser, [{
    key: "parseFromString",
    value: function parseFromString(str, type) {
      var _this$impl;
...
Object.defineProperties(DOMParser.prototype, _defineProperty({
  parseFromString: {
    enumerable: true
  }
}, Symbol.toStringTag, {
...
var Impl = require("../domparsing/DOMParser-impl.js");