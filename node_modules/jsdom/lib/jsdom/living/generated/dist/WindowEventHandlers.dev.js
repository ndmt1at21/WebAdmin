...
function () {
  function WindowEventHandlers() {
    _classCallCheck(this, WindowEventHandlers);

    throw new TypeError("Illegal constructor");
  }

  _createClass(WindowEventHandlers, [{
    key: "onafterprint",
    get: function get() {
...
Object.defineProperties(WindowEventHandlers.prototype, _defineProperty({
  onafterprint: {
    enumerable: true
  },
  onbeforeprint: {
...
var iface = {
  ...
  convert: function convert(obj) {
    ...
    throw new TypeError("".concat(context, " is not of type 'WindowEventHandlers'."));
  },
  create: function create(constructorArgs, privateData) {
    var obj = Object.create(WindowEventHandlers.prototype);
...
var Impl = require("../nodes/WindowEventHandlers-impl.js");