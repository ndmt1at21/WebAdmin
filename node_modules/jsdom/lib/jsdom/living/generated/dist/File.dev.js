...
var File =
/*#__PURE__*/
function (_Blob$interface) {
  _inherits(File, _Blob$interface);
  ...
  function File(fileBits, fileName) {
    ...
    return _possibleConstructorReturn(_this, iface.setup(Object.create((this instanceof File ? this.constructor : void 0).prototype), args));
  }
