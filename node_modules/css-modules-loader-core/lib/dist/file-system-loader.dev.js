...
var _path2 = _interopRequireDefault(_path); // Sorts dependencies in the following way:
    ...
    value: function fetch(_newPath, relativeTo, _trace) {
      ...
      return new Promise(function (resolve, reject) {
        var relativeDir = _path2['default'].dirname(relativeTo),
            ...
            fileRelativePath = _path2['default'].resolve(_path2['default'].join(_this.root, relativeDir), newPath); // if the path is not relative or absolute, try to resolve it in node_modules
