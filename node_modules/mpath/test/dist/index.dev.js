  ...
  describe('get', function () {
    ...
    describe('with `special`', function () {
      ...
      describe('that is a function', function () {
        var special = function special(obj, key) {
          return obj[key];
        };
      ...
      describe('that is a function', function () {
        describe('without map', function () {
          it('works on array value', function (done) {
            ...
            var special = function special(obj, key, val) {
              if (val) {
                obj[key] = val;
              } else {
    ...
    it('get() underneath subclassed array', function (done) {
      ...
      function (_Array) {
        ...
        function MyArray() {
          ...
          return _possibleConstructorReturn(this, _getPrototypeOf(MyArray).apply(this, arguments));
        }
      ...
      var arr = mpath.get('arr.test', obj);
