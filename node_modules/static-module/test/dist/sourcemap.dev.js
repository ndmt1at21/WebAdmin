...
test('source maps', function (t) {
  ...
  var transform = staticModule({
    sheetify: function sheetify(filename) {
  ...
  fs.createReadStream(__dirname + '/sourcemap/main.js').pipe(transform).pipe(concat({
    encoding: 'string'
  }, function (res) {
...
test('retain input source map when file has no static-module use', function (t) {
  ...
  var transform = staticModule({
    not_sheetify: function not_sheetify() {
      return 'whatever';
    }
  }, {
    sourceMap: true,
