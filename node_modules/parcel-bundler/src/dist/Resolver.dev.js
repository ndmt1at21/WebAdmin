...
function () {
  ...
  _createClass(Resolver, [{
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              key = this.getCacheKey(filename, parent);
              ...
              return _context.abrupt("return", this.cache.get(key));
            ...
            case 6:
              ...
              extensions = Array.isArray(this.options.extensions) ? this.options.extensions.slice() : Object.keys(this.options.extensions);
              ...
              _context.next = 11;
              return regeneratorRuntime.awrap(this.resolveModule(filename, parent));
            ...
            case 11:
              ...
              _context.next = 15;
              return regeneratorRuntime.awrap(this.loadNodeModules(module, extensions));
            ...
            case 18:
              ...
              _context.next = 21;
              return regeneratorRuntime.awrap(this.loadRelative(module.filePath, extensions));
    ...
    value: function resolveModule(filename, parent) {
      ...
      return regeneratorRuntime.async(function resolveModule$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 4;
              return regeneratorRuntime.awrap(this.loadAlias(filename, dir));
            ...
            case 7:
              _context2.prev = 7;
              _context2.next = 10;
              return regeneratorRuntime.awrap(this.findNodeModulePath(filename, dir));
    ...
    value: function loadRelative(filename, extensions) {
      var pkg;
      return regeneratorRuntime.async(function loadRelative$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return regeneratorRuntime.awrap(this.findPackage(path.dirname(filename)));

            case 2:
              pkg = _context3.sent;
              _context3.next = 5;
              return regeneratorRuntime.awrap(this.loadAsFile(filename, extensions, pkg));
            ...
            case 5:
              ...
              _context3.next = 9;
              return regeneratorRuntime.awrap(this.loadDirectory(filename, extensions, pkg));
    ...
    value: function findNodeModulePath(filename, dir) {
      ...
      return regeneratorRuntime.async(function findNodeModulePath$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 6:
              ...
              _context4.next = 12;
              return regeneratorRuntime.awrap(fs.stat(moduleDir));
    ...
    value: function loadNodeModules(module, extensions) {
      var pkg, res;
      return regeneratorRuntime.async(function loadNodeModules$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.next = 4;
              return regeneratorRuntime.awrap(this.readPackage(module.moduleDir));

            case 4:
              pkg = _context5.sent;
              _context5.next = 7;
              return regeneratorRuntime.awrap(this.loadAsFile(module.filePath, extensions, pkg));
            ...
            case 10:
              _context5.next = 12;
              return regeneratorRuntime.awrap(this.loadDirectory(module.filePath, extensions));
    ...
    value: function isFile(file) {
      var stat;
      return regeneratorRuntime.async(function isFile$(_context6) {
        while (1) {
    ...
    value: function loadDirectory(dir, extensions, pkg) {
      ...
      return regeneratorRuntime.async(function loadDirectory$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              _context7.prev = 0;
              _context7.next = 3;
              return regeneratorRuntime.awrap(this.readPackage(dir));
            ...
            case 10:
              ...
              file = _step.value;
              _context7.next = 14;
              return regeneratorRuntime.awrap(this.loadAsFile(file, extensions, pkg));
            ...
            case 14:
              ...
              _context7.next = 18;
              return regeneratorRuntime.awrap(this.loadDirectory(file, extensions, pkg));
            ...
            case 43:
              return _context7.abrupt("return", this.loadAsFile(path.join(dir, 'index'), extensions, pkg));
      ...
      }, null, this, [[0, 41], [8, 27, 31, 39], [32,, 34, 38]]);
    }
  }, {
    key: "readPackage",
    value: function readPackage(dir) {
      var file, json, pkg, realpath;
      return regeneratorRuntime.async(function readPackage$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              return _context8.abrupt("return", this.packageCache.get(file));
            ...
            case 5:
              ...
              _context8.next = 12;
              return regeneratorRuntime.awrap(fs.realpath(file));
    ...
    value: function loadAsFile(file, extensions, pkg) {
      ...
      return regeneratorRuntime.async(function loadAsFile$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              ...
              _context9.prev = 3;
              _iterator2 = this.expandFile(file, extensions, pkg)[Symbol.iterator]();
            ...
            case 5:
              ...
              f = _step2.value;
              _context9.next = 9;
              return regeneratorRuntime.awrap(this.isFile(f));
    ...
    value: function findPackage(dir) {
      var root;
      return regeneratorRuntime.async(function findPackage$(_context10) {
        while (1) {
    ...
    value: function loadAlias(filename, dir) {
      var pkg;
      return regeneratorRuntime.async(function loadAlias$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            case 0:
              ...
              _context11.next = 3;
              return regeneratorRuntime.awrap(this.findPackage(this.options.rootDir));

            case 3:
              this.rootPackage = _context11.sent;

            case 4:
              _context11.next = 6;
              return regeneratorRuntime.awrap(this.findPackage(dir));

            case 6:
              pkg = _context11.sent;
              return _context11.abrupt("return", this.resolveAliases(filename, pkg));
