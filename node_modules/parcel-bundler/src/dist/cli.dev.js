...
function bundle(main, command) {
  ...
  return regeneratorRuntime.async(function bundle$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 12;
          return regeneratorRuntime.awrap(bundler.serve(port, command.https, command.host));
        ...
        case 12:
          ...
          _context.next = 16;
          return regeneratorRuntime.awrap(require('./utils/openInBrowser')("".concat(command.https ? 'https' : 'http', "://").concat(command.host || 'localhost', ":").concat(server.address().port), command.open));
