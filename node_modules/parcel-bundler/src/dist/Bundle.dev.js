...
function () {
  ...
  _createClass(Bundle, [{
    ...
    value: function _package(bundler, oldHashes) {
      ...
      return regeneratorRuntime.async(function _package$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              newHashes = _args.length > 2 && _args[2] !== undefined ? _args[2] : new Map();
              promises = [];
              mappings = [];
              ...
              for (_iterator2 = this.childBundles.values()[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                bundle = _step2.value;
            ...
            case 26:
              ...
              _context.next = 30;
              return regeneratorRuntime.awrap(_bundle["package"](bundler, oldHashes, newHashes));
    ...
    value: function _package(bundler) {
      ...
      return regeneratorRuntime.async(function _package$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              Packager = bundler.packagers.get(this.type);
              packager = new Packager(this, bundler);
              startTime = Date.now();
              _context2.next = 5;
              return regeneratorRuntime.awrap(packager.setup());

            case 5:
              _context2.next = 7;
              return regeneratorRuntime.awrap(packager.start());
            ...
            case 7:
              ...
              _context2.prev = 11;
              _iterator3 = this.assets[Symbol.iterator]();
            ...
            case 13:
              ...
              asset = _step3.value;
              _context2.next = 17;
              return regeneratorRuntime.awrap(this._addDeps(asset, packager, included));
            ...
            case 34:
              _context2.next = 36;
              return regeneratorRuntime.awrap(packager.end());

            case 36:
              this.totalSize = packager.getSize();
              assetArray = Array.from(this.assets);
              assetStartTime = this.type === 'map' ? 0 : assetArray.sort(function (a, b) {
                return a.startTime - b.startTime;
              })[0].startTime;
              assetEndTime = this.type === 'map' ? 0 : assetArray.sort(function (a, b) {
    ...
    value: function _addDeps(asset, packager, included) {
      ...
      return regeneratorRuntime.async(function _addDeps$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 8:
              ...
              _context3.next = 12;
              return regeneratorRuntime.awrap(this._addDeps(depAsset, packager, included));
            ...
            case 29:
              _context3.next = 31;
              return regeneratorRuntime.awrap(packager.addAsset(asset));

            case 31:
              assetSize = packager.getSize() - this.totalSize;
