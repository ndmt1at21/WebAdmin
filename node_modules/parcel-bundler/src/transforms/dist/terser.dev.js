  ...
  return regeneratorRuntime.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 2:
          _context.next = 4;
          return regeneratorRuntime.awrap(asset.generate());

        case 4:
          source = _context.sent[0].value;
          _context.next = 7;
          return regeneratorRuntime.awrap(asset.getConfig(['.uglifyrc', '.terserrc']));
        ...
        case 14:
          ...
          _context.next = 18;
          return regeneratorRuntime.awrap(new SourceMap().extendSourceMap(asset.sourceMap, sourceMap));
