...
function (_Asset) {
  ...
  function HTMLAsset(name, options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(HTMLAsset).call(this, name, options));
    _this.type = 'html';
  ...
  _createClass(HTMLAsset, [{
      ...
      return regeneratorRuntime.async(function parse$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(posthtmlTransform.parse(code, this));
      ...
      if (ast.messages) {
        ast.messages.forEach(function (message) {
          if (message.type === 'dependency') {
            _this2.addDependency(message.file, {
      ...
      ast.walk(function (node) {
        if (node.attrs) {
          ...
          if (node.tag === 'link' && node.attrs.rel === 'manifest' && node.attrs.href) {
            node.attrs.href = _this2.getAttrDepHandler('href').call(_this2, node.attrs.href, {
              entry: true
            });
          ...
          for (var attr in node.attrs) {
            ...
            if (elements && elements.includes(node.tag)) {
              var depHandler = _this2.getAttrDepHandler(attr);

              var options = OPTIONS[node.tag];
              node.attrs[attr] = depHandler.call(_this2, attrVal, options && options[attr]);
              _this2.isAstDirty = true;
            }
          }
        }
      ...
      return regeneratorRuntime.async(function pretransform$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return regeneratorRuntime.awrap(posthtmlTransform.transform(this));
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 3;
              return regeneratorRuntime.awrap(htmlnanoTransform(this));
    ...
    value: function postProcess(generated) {
      ...
      return regeneratorRuntime.async(function postProcess$(_context5) {
        while (1) {
