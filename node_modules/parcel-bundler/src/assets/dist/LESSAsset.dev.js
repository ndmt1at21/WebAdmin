...
function (_Asset) {
  ...
  function LESSAsset(name, options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(LESSAsset).call(this, name, options));
    _this.type = 'css';
    return _this;
  }
      ...
      return regeneratorRuntime.async(function parse$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(localRequire('less', this.name));

            case 2:
              less = _context.sent;
              render = promisify(less.render.bind(less));
              _context.next = 6;
              return regeneratorRuntime.awrap(this.getConfig(['.lessrc', '.lessrc.js'], {
                packageKey: 'less'
              }));
    ...
    value: function generate() {
      ...
      if (this.ast && this.ast.map) {
        ...
        map.sources = map.sources.map(function (v) {
          return path.relative(_this2.options.rootDir, v);
        });
      }
  ...
  function (_less$FileManager) {
    ...
    _createClass(LessFileManager, [{
      ...
      value: function loadFile(filename, currentDirectory) {
        var resolved;
        return regeneratorRuntime.async(function loadFile$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                filename = parseCSSImport(filename);
                _context2.next = 3;
                return regeneratorRuntime.awrap(resolver.resolve(filename, path.join(currentDirectory, 'index')));

              case 3:
                resolved = _context2.sent;
                _context2.next = 6;
                return regeneratorRuntime.awrap(fs.readFile(resolved.path, 'utf8'));
