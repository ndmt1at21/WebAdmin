    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.next = 7;
          return regeneratorRuntime.awrap(Promise.all(Object.keys(plugins).map(function (p) {
...
function loadPlugin(plugin, relative, options) {
  return regeneratorRuntime.async(function loadPlugin$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return regeneratorRuntime.awrap(localRequire(plugin, relative));
