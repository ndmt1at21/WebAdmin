...
function resolve(filepath, filenames) {
  var root,
  ...
  return regeneratorRuntime.async(function resolve$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 16:
          _context.next = 18;
          return regeneratorRuntime.awrap(fs.exists(file));
  ...
  }, null, null, [[7, 28, 32, 40], [33,, 35, 39]]);
}

function load(filepath, filenames) {
  var root,
      configFile,
      extname,
      configContent,
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 3;
          return regeneratorRuntime.awrap(resolve(filepath, filenames, root));
        ...
        case 9:
          _context2.next = 11;
          return regeneratorRuntime.awrap(fs.readFile(configFile));
