...
function pipeSpawn(cmd, params, opts) {
  var cp = spawn(cmd, params, Object.assign({
    env: Object.assign({
  ...
  cp.stdout.setEncoding('utf8').on('data', function (d) {
    return logger.writeRaw(d);
  });
  cp.stderr.setEncoding('utf8').on('data', function (d) {
    return logger.writeRaw(d);
  });
