...
function _getTargetEngines() {
  _getTargetEngines = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(asset, isTargetApp) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return asset.getConfig(['package.json'], {
              path: path
            });
          ...
          case 20:
            _context.next = 22;
            return loadBrowserslist(asset, path);
...
function _loadBrowserslist() {
  _loadBrowserslist = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(asset, path) {
    var config;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return asset.getConfig(['browserslist', '.browserslistrc'], {
              path: path,
              load: false
            });
...
function _loadBabelrc() {
  _loadBabelrc = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(asset, path) {
    var config, env;
