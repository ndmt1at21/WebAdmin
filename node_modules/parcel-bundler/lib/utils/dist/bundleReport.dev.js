...
function bundleReport(mainBundle) {
  ...
  try {
    var _loop = function _loop() {
      var bundle = _step.value; // Add a row for the bundle
      ...
      if (detailed && bundle.assets.size > 1) {
        ...
        try {
          for (_iterator2 = largestAssets[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var asset = _step2.value; // Add a row for the asset.
