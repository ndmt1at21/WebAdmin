...
function middleware(bundler) {
  ...
  return function (req, res, next) {
    ...
    function send500(error) {
      ...
      res.writeHead(500);
      var errorMesssge = '<h1>🚨 Build Error</h1>';
...
function _serve() {
  _serve = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(bundler, port, host) {
    var useHTTPS,
        handler,
        server,
        freePort,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            _context.t0 = https;
            _context.next = 13;
            return getCertificate(useHTTPS);
