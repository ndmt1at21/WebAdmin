    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.next = 9;
            return postcss(config.plugins).process(asset.getCSSAst(), config);
...
function _getConfig() {
  ...
  regeneratorRuntime.mark(function _callee2(asset) {
    var config, enableModules, postcssModulesConfig, postcssModules, cssnano, _ref3, version;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return asset.getConfig(['.postcssrc', '.postcssrc.json', '.postcssrc.js', 'postcss.config.js'], {
              packageKey: 'postcss'
            });
          ...
          case 10:
            ...
            _context2.next = 14;
            return loadPlugins(config.plugins, asset.name);
          ...
          case 14:
            ...
            _context2.next = 18;
            return localRequire('postcss-modules', asset.name);
          ...
          case 20:
            ...
            _context2.next = 23;
            return localRequire('cssnano', asset.name);

          case 23:
            cssnano = _context2.sent;
            _context2.next = 26;
            return localRequire('cssnano/package.json', asset.name);
          ...
          case 26:
            ...
            _context2.next = 32;
            return asset.getConfig(['cssnano.config.js']);
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 7:
                    ...
                    _context3.next = 10;
                    return _this.core.load(source, rootRelativePath, undefined, _this.fetch.bind(_this));
