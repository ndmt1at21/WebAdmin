        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                contents = asset.generated[_this.bundle.type];
                ...
                _context.next = 4;
                return fs.readFile(contents ? contents.path : asset.name);
              ...
              case 5:
                ...
                _context.next = 8;
                return fs.mkdirp(path.dirname(_this.bundle.name));

              case 8:
                _this.size = contents.length;
                _context.next = 11;
                return fs.writeFile(_this.bundle.name, contents);
