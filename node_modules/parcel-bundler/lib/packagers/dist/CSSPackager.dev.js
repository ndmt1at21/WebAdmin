  ...
  _createClass(CSSPackager, [{
    ...
    value: function end() {
      ...
      var _this3 = this,
        ...
        return (_get2 = _get(_getPrototypeOf(CSSPackager.prototype), "end", _this4)).call.apply(_get2, [_this4].concat(_args));
      };
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                mapBundle = _this3.bundle.siblingBundlesMap.get('map');
                ...
                mapUrl = urlJoin(_this3.options.publicURL, path.basename(mapBundle.name));
                _context3.next = 6;
