...
/*#__PURE__*/
function (_Asset) {
  _inherits(RawAsset, _Asset);

  function RawAsset() {
    _classCallCheck(this, RawAsset);

    return _possibleConstructorReturn(this, _getPrototypeOf(RawAsset).apply(this, arguments));
  }

  _createClass(RawAsset, [{
    key: "load",
    ...
    value: function generate() {
      ...
      var pathToAsset = urlJoin(this.options.publicURL, this.generateBundleName());
      return [{
        type: 'js',
        value: "module.exports=".concat(JSON.stringify(pathToAsset), ";")
      }];
    }
  }, {
    key: "generateHash",
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", md5.file(_this.name));
