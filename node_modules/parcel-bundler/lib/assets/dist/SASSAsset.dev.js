...
function (_Asset) {
  ...
  function SASSAsset(name, options) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(SASSAsset).call(this, name, options));
    _this2.type = 'css';
    return _this2;
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return getSassRuntime(_this.name);
              ...
              case 2:
                ...
                _context.next = 7;
                return _this.getConfig(['.sassrc', '.sassrc.js'], {
                  packageKey: 'sass'
                });
              ...
              case 10:
                ...
                type = _this.options.rendition ? _this.options.rendition.type : path.extname(_this.name).toLowerCase().replace('.', '');
...
function _getSassRuntime() {
  _getSassRuntime = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(searchPath) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return localRequire('node-sass', searchPath, true);
