...
function (_Asset) {
  ...
  function GlobAsset(name, options) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(GlobAsset).call(this, name, options));
    _this2.type = null; // allows this asset to be included in any type bundle
            ...
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                for (_iterator = files[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                  ...
                  relative = './' + path.relative(path.dirname(_this.name), file.normalize('NFC'));
