...
function (_Asset) {
  ...
  function VueAsset(name, options) {
    ...
    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(VueAsset).call(this, name, options));
    _this4.type = 'js';
    return _this4;
  }
  ...
  _createClass(VueAsset, [{
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return localRequire('vue-template-compiler', _this.name);

              case 2:
                _this.vueTemplateCompiler = _context.sent;
                _context.next = 5;
                return localRequire('@vue/component-compiler-utils', _this.name);

              case 5:
                _this.vue = _context.sent;
                return _context.abrupt("return", _this.vue.parse({
                  source: code,
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                result = [];
                hasScoped = _this3.ast.styles.some(function (s) {
                  return s.scoped;
                });
                id = md5(_this3.name).slice(-6);
                scopeId = hasScoped ? "data-v-".concat(id) : null;
                optsVar = '$' + id; // Generate JS output.

                js = _this3.ast.script ? generated[0].value : '';
                supplemental = ''; // TODO: make it possible to process this code with the normal scope hoister

                if (_this3.options.scopeHoist) {
                  optsVar = "$".concat(t.toIdentifier(_this3.id), "$export$default");

                  if (!js.includes(optsVar)) {
                    optsVar = "$".concat(t.toIdentifier(_this3.id), "$exports");
              ...
              case 18:
                ...
                css = _this3.compileStyle(generated, scopeId);
    ...
    value: function compileStyle(generated, scopeId) {
      ...
      return generated.filter(function (r) {
        ...
        var css = r.value;
        var scoped = _this5.ast.styles[i].scoped; // Process scoped styles if needed.

        if (scoped) {
          var _this$vue$compileStyl = _this5.vue.compileStyle({
            source: css,
            filename: _this5.relativeName,
            id: scopeId,
            scoped: scoped
          }),
