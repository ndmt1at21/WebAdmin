...
var _asyncToGenerator2 = _interopRequireDefault(require("@babel/runtime/helpers/asyncToGenerator")); // const CSSAsset = require('./CSSAsset');
...
function (_Asset) {
  ...
  function StylusAsset(name, options) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(StylusAsset).call(this, name, options));
    _this2.type = 'css';
    return _this2;
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return localRequire('stylus', _this.name);

              case 2:
                stylus = _context.sent;
                _context.next = 5;
                return _this.getConfig(['.stylusrc', '.stylusrc.js'], {
                  packageKey: 'stylus'
                });
              ...
              case 5:
                ...
                style.define('url', function (node) {
                  var filename = _this.addURLDependency(node.val, node.filename);

                  return new stylus.nodes.Literal("url(".concat(JSON.stringify(filename), ")"));
                });
                _context.t0 = style;
                _context.next = 13;
                return createEvaluator(code, _this, style.options);
...
function _getDependencies() {
  _getDependencies = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee3(code, filepath, asset, options) {
    var seen,
        _ref,
        _ref2,
        Parser,
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            seen.add(filepath);
            _context3.next = 4;
            return Promise.all(['parser', 'visitor/deps-resolver', 'nodes', 'utils'].map(function (dep) {
          ...
          case 4:
            ...
            res = new Map();
            _context3.next = 20;
            return Promise.all(Array.from(deps.entries()).map(
            /*#__PURE__*/
            function () {
              var _ref3 = (0, _asyncToGenerator2["default"])(
              /*#__PURE__*/
              regeneratorRuntime.mark(function _callee2(_ref4) {
                var _ref5, path, resolved, found, originalPath, paths, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _resolved, _code, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _step3$value, _path, resolvedPath;

                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        _ref5 = _slicedToArray(_ref4, 2), path = _ref5[0], resolved = _ref5[1];
                        _context2.prev = 1;
                        _context2.next = 4;
                        return resolved;
                      ...
                      case 23:
                        ...
                        _context2.prev = 26;
                        _iterator2 = found[Symbol.iterator]();
                      ...
                      case 28:
                        ...
                        _context2.next = 34;
                        return fs.readFile(_resolved, 'utf8');
                      ...
                      case 34:
                        ...
                        _context2.prev = 38;
                        _context2.next = 41;
                        return getDependencies(_code, _resolved, asset, options, seen);

                      case 41:
                        _context2.t1 = Symbol.iterator;
                        _iterator3 = _context2.sent[_context2.t1]();
                      ...
                      case 43:
                        ...
                        _step3$value = (0, _slicedToArray2["default"])(_step3.value, 2), _path = _step3$value[0], resolvedPath = _step3$value[1];
                ...
                }, _callee2, null, [[1, 8], [26, 68, 72, 80], [38, 51, 55, 63], [56,, 58, 62], [73,, 75, 79]]);
              }));
...
function _createEvaluator() {
  _createEvaluator = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee4(code, asset, options) {
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return getDependencies(code, asset.name, asset, options);

          case 2:
            deps = _context4.sent;
            _context4.next = 5;
            return localRequire('stylus/lib/visitor/evaluator', asset.name);
