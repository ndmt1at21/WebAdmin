...
function (_Asset) {
  ...
  function PugAsset(name, options) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(PugAsset).call(this, name, options));
    _this2.type = 'html';
    _this2.hmrPageReload = true;
    return _this2;
  }
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return localRequire('pug', _this.name);

              case 2:
                pug = _context.sent;
                _context.next = 5;
                return _this.getConfig(['.pugrc', '.pugrc.js', 'pug.config.js']);
              ...
              case 8:
                config = _context.t0;
                compiled = pug.compile(_this.contents, {
                  compileDebug: false,
                  filename: _this.name,
