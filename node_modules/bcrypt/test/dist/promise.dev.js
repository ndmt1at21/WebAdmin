...
if (typeof Promise !== 'undefined') {
  module.exports = {
    ...
    test_change_promise_impl_reject: function test_change_promise_impl_reject(assert) {
      ...
      assert.equal(promises.reject(), 'mock'); // need to reset the promise implementation because of require cache
    ...
    test_change_promise_impl_promise: function test_change_promise_impl_promise(assert) {
      ...
      assert.equal(promises.promise('', '', ''), 'mock'); // need to reset the promise implementation because of require cache
