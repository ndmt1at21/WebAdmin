...
var connect = require('./operations/connect').connect;

var validOptions = require('./operations/connect').validOptions;
/**
...
MongoClient.prototype.connect = function (callback) {
  ...
  return maybePromise(this, callback, function (cb) {
    var err = validOptions(client.s.options);
    if (err) return cb(err);
    connect(client, client.s.url, client.s.options, function (err) {
      if (err) return cb(err);
      cb(null, client);
    });
  });
