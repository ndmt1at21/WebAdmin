...
Collection.prototype.createIndex = function (fieldOrSpec, options, callback) {
  if (typeof options === 'function') callback = options, options = {};
  options = options || {};
  var createIndexesOperation = new CreateIndexesOperation(this, this.collectionName, fieldOrSpec, options);
...
Collection.prototype.createIndexes = function (indexSpecs, options, callback) {
  ...
  var createIndexesOperation = new CreateIndexesOperation(this, this.collectionName, indexSpecs, options);
  return executeOperation(this.s.topology, createIndexesOperation, callback);
};
/**
