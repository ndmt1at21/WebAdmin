...
var ReadPreference = function ReadPreference(mode, tags, options) {
  ...
  if (tags && !Array.isArray(tags)) {
    ...
    var tagsHasMaxStalenessSeconds = typeof tags.maxStalenessSeconds !== 'undefined';
    var tagsHasHedge = typeof tags.hedge !== 'undefined';
    var tagsHasOptions = tagsHasMaxStalenessSeconds || tagsHasHedge;
...
ReadPreference.fromOptions = function (options) {
  ...
  var maxStalenessSeconds = options.maxStalenessSeconds;
...
ReadPreference.resolve = function (parent, options) {
  ...
  var inheritedReadPreference = parent && parent.readPreference;
  var readPreference;
