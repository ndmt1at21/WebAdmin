...
var legacyIsRetryableWriteError = require('./shared').legacyIsRetryableWriteError;
/**
...
var Mongos = function Mongos(seedlist, options) {
  ...
  if (Array.isArray(seedlist)) {
    seedlist = seedlist.reduce(function (seeds, seed) {
      if (seeds.find(function (s) {
        return s.host === seed.host && s.port === seed.port;
      })) {
        return seeds;
      }
