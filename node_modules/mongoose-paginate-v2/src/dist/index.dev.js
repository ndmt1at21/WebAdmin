...
function paginate(query, options, callback) {
  ...
  return Promise.all([countPromise, docsPromise]).then(function (values) {
    ...
    var meta = _defineProperty({}, labelTotal, count);
    ...
    if (labelMeta) {
      ...
      result = (_result = {}, _defineProperty(_result, labelDocs, docs), _defineProperty(_result, labelMeta, meta), _result);
    } else {
      result = _objectSpread(_defineProperty({}, labelDocs, docs), meta);
    }
