...
var mongoosePaginate = require('../dist/index');

var MONGO_URI = 'mongodb://localhost/mongoose_paginate_test';
...
describe('mongoose-paginate', function () {
  ...
  it('with page and limit', function () {
    ...
    return Book.paginate(query, options).then(function (result) {
  ...
  */
  ...
  it('count Custom Fn works', function (done) {
    Book.paginate({}, {
      useCustomCountFn: function useCustomCountFn() {
        return 100;
      }
    }, function (err, result) {
      expect(err).to.be["null"];
