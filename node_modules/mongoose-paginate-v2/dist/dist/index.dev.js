...
function paginate(query, options, callback) {
  ...
  return Promise.all([countPromise, docsPromise]).then(function (values) {
    ...
    var meta = _defineProperty2({}, labelTotal, count);
    ...
    if (labelMeta) {
      ...
      result = (_result = {}, _defineProperty2(_result, labelDocs, docs), _defineProperty2(_result, labelMeta, meta), _result);
    } else {
      result = _objectSpread(_defineProperty2({}, labelDocs, docs), meta);
    }
