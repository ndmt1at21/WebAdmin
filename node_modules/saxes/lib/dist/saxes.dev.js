...
var _require2 = require("xmlchars/xmlns/1.0/ed3"),
    ...
    NC_NAME_RE = _require2.NC_NAME_RE;
...
var S_INITIAL = "sInitial"; // initial state

var S_BEGIN_WHITESPACE = "sBeginWhitespace"; // leading whitespace

var S_DOCTYPE = "sDoctype"; // <!DOCTYPE

var S_DOCTYPE_QUOTE = "sDoctypeQuote"; // <!DOCTYPE "//blah

var S_DTD = "sDTD"; // <!DOCTYPE "//blah" [ ...

var S_DTD_QUOTED = "sDTDQuoted"; // <!DOCTYPE "//blah" [ "foo

var S_DTD_OPEN_WAKA = "sDTDOpenWaka";
var S_DTD_OPEN_WAKA_BANG = "sDTDOpenWakaBang";
var S_DTD_COMMENT = "sDTDComment"; // <!--

var S_DTD_COMMENT_ENDING = "sDTDCommentEnding"; // <!-- blah -

var S_DTD_COMMENT_ENDED = "sDTDCommentEnded"; // <!-- blah --

var S_DTD_PI = "sDTDPI"; // <?

var S_DTD_PI_ENDING = "sDTDPIEnding"; // <?hi "there" ?

var S_TEXT = "sText"; // general stuff

var S_ENTITY = "sEntity"; // &amp and such
...
function () {
  ...
  _createClass(SaxesParser, [{
    ...
    key: "captureToChar",
    value: function captureToChar(_char, buffer) {
      var chunk = this.chunk,
          limit = this.limit,
          start = this.i;
    ...
    value: function sInitial() {
      ...
      var c = this.chunk.charCodeAt(0); // If the initial character is 0xFEFF, ignore it.
    ...
    value: function handleTextInRoot() {
      ...
      var chunk = this.chunk,
          limit = this.limit,
          start = this.i;
      var forbiddenState = this.forbiddenState;
      var c; // eslint-disable-next-line no-labels, no-restricted-syntax
    ...
    key: "sDTD",
    value: function sDTD() {
      var c = this.captureTo(DTD_TERMINATOR, "doctype");
    ...
    value: function sDTDOpenWakaBang() {
      var _char2 = String.fromCodePoint(this.getCode());
    ...
    value: function sAttribValueQuoted() {
      ...
      while (true) {
        ...
        if (code === q || code === AMP || code === LESS) {
          // This is faster than adding codepoints one by one.
          var slice = chunk.substring(start, this.i - (code <= 0xFFFF ? 1 : 2));
