...
function (_EventEmitter) {
  ...
  function Watcher() {
    ...
    _this.options = optionsTransfer.encode(options);
    _this.watchedPaths = new Set();
    _this.child = null;
    _this.ready = false;
    _this.readyQueue = [];
    _this.watchedDirectories = new Map();
    _this.stopped = false;
    ...
    _this.on('ready', function () {
      ...
      try {
        for (var _iterator = _this.readyQueue[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  _createClass(Watcher, [{
    ...
    value: function startchild() {
      ...
      this.child.on('message', function (msg) {
        return _this2.handleEmit(msg.event, msg.path);
      });
      this.child.on('error', function () {});
      this.child.on('exit', function () {
        return _this2.handleClosed();
    ...
    value: function sendCommand(func, args) {
      ...
      if (!this.ready) {
        return this.readyQueue.push(function () {
          return _this3.sendCommand(func, args);
        });
      }
    ...
    value: function stop() {
      ...
      return regeneratorRuntime.async(function stop$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", new Promise(function (resolve) {
                return _this4.once('childDead', resolve);
              }));
