...
function (_Date) {
  ...
  _createClass(FloatingDateTime, [{
    ...
    value: function toISOString() {
      var date = "".concat(this.getUTCFullYear(), "-").concat(f(2, this.getUTCMonth() + 1), "-").concat(f(2, this.getUTCDate()));
      var time = "".concat(f(2, this.getUTCHours()), ":").concat(f(2, this.getUTCMinutes()), ":").concat(f(2, this.getUTCSeconds()), ".").concat(f(3, this.getUTCMilliseconds()));
