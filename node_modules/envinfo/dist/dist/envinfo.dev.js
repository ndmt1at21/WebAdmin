...
module.exports = function (e) {
  ...
  var r = n(0),
    ...
    var t = "mdfind \"kMDItemCFBundleIdentifier=='".concat(e, "'\"");
    ...
    return ["/usr/libexec/PlistBuddy"].concat(n).concat([e]).join(" ");
      ...
      v = function v(e, t) {
    for (var n = [], r = null; null !== (r = e.exec(t));) {
      n.push(r);
    }
  ...
  e.exports = {
    run: l,
    log: f,
    fileExists: function fileExists(e) {
      return new Promise(function (t) {
        o.stat(e, function (n) {
          return t(n ? null : e);
        });
    ...
    matchAll: v,
    parseSDKManagerOutput: function parseSDKManagerOutput(e) {
    ...
    isObject: function isObject(e) {
      return "object" == _typeof(e) && !Array.isArray(e);
    },
    ...
    getDarwinApplicationVersion: function getDarwinApplicationVersion(e) {
      var t;
    ...
    toReadableBytes: function toReadableBytes(e) {
      var t = Math.floor(Math.log(e) / Math.log(1024));
      return e ? (e / Math.pow(1024, t)).toFixed(2) + " " + ["B", "KB", "MB", "GB", "TB", "PB"][t] : "0 Bytes";
    },
    omit: function omit(e, t) {
      return Object.keys(e).filter(function (e) {
        return t.indexOf(e) < 0;
      }).reduce(function (t, n) {
        return Object.assign(t, _defineProperty({}, n, e[n]));
      }, {});
    },
    ...
    condensePath: function condensePath(e) {
      return (e || "").replace(i.homedir(), "~");
    },
    determineFound: function determineFound(e, t, n) {
  ...
  var r,
    ...
    if (!e._n) {
      ...
      var n = e._c;
      y(function () {
        for (var r = e._v, o = 1 == e._s, i = 0, s = function s(t) {
          var n,
              i,
              s,
              a = o ? t.ok : t.fail,
  ...
  N || (_I = function I(e) {
    d(this, _I, "Promise", "_h"), h(e), r.call(this);
    ...
    return e === _I || e === s ? new i(e) : o(e);
  }), f(f.G + f.W + f.F * !N, {
    Promise: _I
  }), n(26)(_I, "Promise"), n(63)("Promise"), s = n(19).Promise, f(f.S + f.F * !N, "Promise", {
  ...
  var r = n(4),
    ...
    for (u in d && (n = t), n) {
      f = ((l = !h && y && void 0 !== y[u]) ? y : n)[u], p = v && l ? a(f, r) : g && "function" == typeof f ? a(Function.call, f) : f, y && s(y, u, f, e & c.U), b[u] != f && i(b, u, p), g && w[u] != f && (w[u] = f);
    }
  };
  ...
  n(28)("split", 2, function (e, t, r) {
    ...
    if ("c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length) {
      ...
      r = function r(e, t) {
        ...
        }), c.length > 1 && c.index < n.length && s.apply(p, c.slice(1)), l = c[0].length, d = u, p.length >= m));) {
  ...
  (t = e.exports = function (e, t, n, f, p) {
    ...
    } else for (m = v.call(e); !(d = m.next()).done;) {
  ...
  b.glob = b, b.hasMagic = function (e, t) {
    var n = function (e, t) {
      if (null === t || "object" != _typeof(t)) return e;
    ...
    if (u(this instanceof x), u("function" == typeof r), !this.aborted) if (this._processing++, this.paused) this._processQueue.push([e, t, n, r]);else {
      for (var o, s = 0; "string" == typeof e[s];) {
        s++;
      }
  ...
  d.filter = function (e, t) {
    ...
    var t = d,
        n = function n(_n2, r, o) {
      return t.minimatch(_n2, r, h(e, o));
    };
    ...
    for (var x, S = 0, P = e.length; S < P && (x = e.charAt(S)); S++) {
      if (this.debug("%s\t%s %s %j", e, S, i, x), l && f[x]) i += "\\" + x, l = !1;else switch (x) {
        case "/":
          return !1;
  ...
  p && h || (p = function p(e) {
    ...
    delete v[e];
  }, "process" == n(21)(f) ? r = function r(e) {
    f.nextTick(s(y, e, 1));
  } : m && m.now ? r = function r(e) {
    m.now(s(y, e, 1));
  } : d ? (i = (o = new d()).port2, o.port1.onmessage = b, r = s(i.postMessage, i, 1)) : l.addEventListener && "function" == typeof postMessage && !l.importScripts ? (r = function r(e) {
    l.postMessage(e + "", "*");
  ...
  e.exports = function (e) {
    return function (t) {
      for (var n, s = o(t), a = r(s), c = a.length, u = 0, l = []; c > u;) {
        i.call(s, n = a[u++]) && l.push(e ? [n, s[n]] : s[n]);
      }
  ...
  var r = n(7),
    ...
    for (t.style.display = "none", n(61).appendChild(t), t.src = "javascript:", (e = t.contentWindow.document).open(), e.write("<script>document.F=Object<\/script>"), e.close(), _c = e.F; r--;) {
  ...
  e.exports = Object.create || function (e, t) {
    var n;
    return null !== e ? (a.prototype = r(e), n = new a(), a.prototype = null, n[s] = e) : n = _c(), void 0 === t ? n : o(n, t);
  };
}, function (e, t, n) {
  var r = n(24)("meta"),
      o = n(6),
  ...
  e.exports = function (e) {
    ...
    return "win32" !== (e.platform || process.platform) ? "PATH" : Object.keys(t).find(function (e) {
  ...
  function a(e, t) {
    ...
    var n = Object.keys(e).length > 0 ? e : i.defaults,
      ...
      return s ? (i && e.push(s(i, t)), e) : e = e.concat((i || []).map(function (e) {
        var t = r["get".concat(e.replace(/\s/g, ""), "Info")];
        return t ? t() : Promise.resolve(["Unknown"]);
      }));
    }, []);
    return Promise.all(s).then(function (e) {
      var n = e.reduce(function (e, t) {
        return t && t[0] && Object.assign(e, _defineProperty({}, t[0], t)), e;
      }, {});
      return function (e, t) {
        ...
        var r = t[0],
            o = t[1];
        return n[r] ? Object.assign(e, _defineProperty({}, r, n[r][1])) : Object.assign(e, _defineProperty({}, r, (o || []).reduce(function (e, t) {
          return n[t] ? (n[t].shift(), 1 === n[t].length ? Object.assign(e, _defineProperty({}, t, n[t][0])) : Object.assign(e, _defineProperty({}, t, {
            version: n[t][0],
            path: n[t][1]
          }))) : e;
        }, {})));
  ...
  e.exports = {
    cli: function cli(e) {
      ...
      if (e.helper) {
        var t = r["get".concat(e.helper)] || r["get".concat(e.helper, "Info")] || r[e.helper];
  ...
  e.exports = !c || n(10)(function () {
    ...
    for (var n = s(e), c = arguments.length, u = 1, l = o.f, f = i.f; c > u;) {
      for (var p, h = a(arguments[u++]), d = l ? r(h).concat(l(h)) : r(h), m = d.length, g = 0; m > g;) {
  ...
  e.exports = {
    getnpmPackages: function getnpmPackages(e, t) {
    ...
    getnpmGlobalPackages: function getnpmGlobalPackages(e, t) {
      ...
      return "string" == typeof e ? e.includes("*") || e.includes("?") || e.includes("+") || e.includes("!") ? n = e : e = e.split(",") : Array.isArray(e) || (e = !0), Promise.all(["npmGlobalPackages", i.run("npm get prefix --global").then(function (e) {
        ...
        return e.reduce(function (e, t) {
          return t ? Object.assign(e, _defineProperty({}, t.name, t.version)) : e;
        }, {});
      }).then(function (n) {
        return t.showNotFound && Array.isArray(e) && e.forEach(function (e) {
          n[e] || (n[e] = "Not Found");
  ...
  function a(e) {
    return "function" == typeof e ? e : function () {
      ...
      if (s) {
        ...
        e = function e(_e) {
          _e && (t.message = _e.message, n(_e = t));
        };
      } else e = n;
  ...
  function i(e, t, n) {
    ...
    if (c >= 0 && u > 0) {
      for (r = [], i = n.length; l >= 0 && !a;) {
        l == c ? (r.push(l), c = n.indexOf(e, l + 1)) : 1 == r.length ? a = [r.pop(), u] : ((o = r.pop()) < i && (i = o, s = u), u = n.indexOf(t, l + 1)), l = c < u && c >= 0 ? c : u;
      }
  ...
  m.prototype._finish = function () {
    ...
    for (var r, o = 0; "string" == typeof e[o];) {
      o++;
    }
  ...
  e.exports = function (e, t, n, d, m, g, v) {
    ...
    if (A && (w = l(A.call(new e()))) !== Object.prototype && w.next && (u(w, S, !0), r || "function" == typeof w[f] || s(w, f, h)), P && _ && "values" !== _.name && (O = !0, I = function I() {
      return _.call(this);
  ...
  o(o.S + o.F * !n(41)(function (e) {
    ...
    from: function from(e) {
      var t,
          ...
          v = 0,
          y = l(p);
      if (g && (m = r(m, d > 2 ? arguments[2] : void 0, 2)), null == y || h == Array && a(y)) for (n = new h(t = c(p.length)); t > v; v++) {
        u(n, v, g ? m(p[v], v) : p[v]);
      } else for (f = y.call(p), n = new h(); !(o = f.next()).done; v++) {
        u(n, v, g ? s(f, m, [o.value, v], !0) : o.value);
      }
      return n.length = v, n;
    }
  });
  ...
  var r = n(5),
      ...
      s = n(0);
  e.exports = {
    getBraveBrowserInfo: function getBraveBrowserInfo() {
    ...
    getEdgeInfo: function getEdgeInfo() {
      ...
      if (i.log("trace", "getEdgeInfo"), i.isWindows && "10" === o.release().split(".")[0]) {
        ...
        e = Promise.all(Object.keys(t).map(function (e) {
          return function (e, t) {
            return i.run("powershell get-appxpackage ".concat(e)).then(function (e) {
              if ("" !== i.findVersion(e)) return "".concat(t, " (").concat(i.findVersion(e), ")");
            });
          }(t[e], e);
        }).filter(function (e) {
          return void 0 !== e;
    ...
    getInternetExplorerInfo: function getInternetExplorerInfo() {
      ...
      if (i.log("trace", "getInternetExplorerInfo"), i.isWindows) {
        ...
        e = i.run("wmic datafile where \"name='".concat(t, "'\" get Version")).then(i.findVersion);
      } else e = Promise.resolve("N/A");
  ...
  e.exports = {
    ...
    getMySQLInfo: function getMySQLInfo() {
      return r.log("trace", "getMySQLInfo"), Promise.all([r.run("mysql --version").then(function (e) {
        return "".concat(r.findVersion(e, null, 1)).concat(e.includes("MariaDB") ? " (MariaDB)" : "");
  ...
  e.exports = {
    getAndroidStudioInfo: function getAndroidStudioInfo() {
      ...
      return o.isMacOS ? e = o.run(o.generatePlistBuddyCommand(r.join("/", "Applications", "Android\\ Studio.app", "Contents", "Info.plist"), ["CFBundleShortVersionString", "CFBundleVersion"])).then(function (e) {
        ...
        return "".concat(e[0], " ").concat(e[1]).trim() || o.NotFound;
    ...
    getVisualStudioInfo: function getVisualStudioInfo() {
      return o.log("trace", "getVisualStudioInfo"), o.isWindows ? o.run("\"".concat(process.env["ProgramFiles(x86)"], "/Microsoft Visual Studio/Installer/vswhere.exe\" -format json -prerelease")).then(function (e) {
        ...
        return o.determineFound("Visual Studio", t.map(function (e) {
          return "".concat(e.Version, " (").concat(e.DisplayName, ")");
        }));
      })["catch"](function () {
    ...
    getXcodeInfo: function getXcodeInfo() {
      return o.log("trace", "getXcodeInfo"), o.isMacOS ? Promise.all([o.which("xcodebuild").then(function (e) {
        ...
        return "".concat(o.findVersion(e), "/").concat(e.split("Build version ")[1]);
  ...
  e.exports = {
    ...
    getErlangInfo: function getErlangInfo() {
    ...
    getProtocInfo: function getProtocInfo() {
    ...
    getPython3Info: function getPython3Info() {
  ...
  var r = n(1);
  e.exports = {
    getAptInfo: function getAptInfo() {
    ...
    getCargoInfo: function getCargoInfo() {
    ...
    getCocoaPodsInfo: function getCocoaPodsInfo() {
    ...
    getComposerInfo: function getComposerInfo() {
    ...
    getGradleInfo: function getGradleInfo() {
    ...
    getMavenInfo: function getMavenInfo() {
    ...
    getpip2Info: function getpip2Info() {
    ...
    getpip3Info: function getpip3Info() {
    ...
    getRubyGemsInfo: function getRubyGemsInfo() {
    ...
    getYumInfo: function getYumInfo() {
  ...
  var r = n(1),
      o = n(0);
  e.exports = {
    getYarnWorkspacesInfo: function getYarnWorkspacesInfo() {
    ...
    getLernaInfo: function getLernaInfo() {
  ...
  e.exports = {
    getAndroidSDKInfo: function getAndroidSDKInfo() {
      return i.run("sdkmanager --list").then(function (e) {
        return !e && process.env.ANDROID_HOME ? i.run("".concat(process.env.ANDROID_HOME, "/tools/bin/sdkmanager --list")) : e;
      }).then(function (e) {
        return !e && process.env.ANDROID_HOME ? i.run("".concat(process.env.ANDROID_HOME, "/cmdline-tools/latest/bin/sdkmanager --list")) : e;
      }).then(function (e) {
    ...
    getWindowsSDKInfo: function getWindowsSDKInfo() {
      if (i.log("trace", "getWindowsSDKInfo"), i.isWindows) {
        ...
        return i.run("reg query HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\AppModelUnlock").then(function (t) {
          ...
          try {
            var n = r.readdirSync("".concat(process.env["ProgramFiles(x86)"], "/Windows Kits/10/Platforms/UAP"));
            e.Versions = n;
          } catch (e) {}
  ...
  e.exports = {
    ...
    getMemoryInfo: function getMemoryInfo() {
      return o.log("trace", "getMemoryInfo"), Promise.all(["Memory", "".concat(o.toReadableBytes(i.freemem()), " / ").concat(o.toReadableBytes(i.totalmem()))]);
    },
    ...
    getShellInfo: function getShellInfo() {
      if (o.log("trace", "getShellInfo", process.env), o.isMacOS || o.isLinux) {
        var e = process.env.SHELL || o.runSync("getent passwd $LOGNAME | cut -d: -f7 | head -1"),
            t = "".concat(e, " --version 2>&1");
        return e.match("/bin/ash") && (t = "".concat(e, " --help 2>&1")), Promise.all([o.run(t).then(o.findVersion), o.which(e)]).then(function (e) {
    ...
    getGLibcInfo: function getGLibcInfo() {
  ...
  var r = n(18),
      ...
      i = function i(e) {
    return e = Number((e || r.release()).split(".")[0]), {
      name: o.get(e),
      version: "10." + (e - 4)
    };
  };
  ...
  e.exports = function (e) {
    var t = /\d+\.\d/.exec(e || r.release());
    if (e && !t) throw new Error("`release` argument doesn't match `n.n`");
    var n = (t || [])[0];

    if ((!e || e === r.release()) && ["6.1", "6.2", "6.3", "10.0"].includes(n)) {
      var _e2 = ((o.sync("wmic", ["os", "get", "Caption"]).stdout || "").match(/2008|2012|2016/) || [])[0];
      if (_e2) return "Server ".concat(_e2);
    }
  ...
  function v(e, t, n) {
    var r = "/bin/sh",
        o = ["-c", t];
    return n = Object.assign({}, n), "win32" === process.platform && (n.__winShell = !0, r = process.env.comspec || "cmd.exe", o = ["/s", "/c", "\"".concat(t, "\"")], n.windowsVerbatimArguments = !0), n.shell && (r = n.shell, delete n.shell), e(r, o, n);
  }
  ...
  function y(e, t, _ref) {
    ...
    return (i = r ? n ? u(e[t], {
      ...
      throw e.stream = t, e.message = "".concat(t, " ").concat(e.message), e;
    });
  }
  ...
  function b(e, t) {
    ...
    if (!o) {
      var _e3 = "";
      Array.isArray(a.opts.stdio) ? ("inherit" !== a.opts.stdio[2] && (_e3 += _e3.length > 0 ? r : "\n".concat(r)), "inherit" !== a.opts.stdio[1] && (_e3 += "\n".concat(n))) : "inherit" !== a.opts.stdio && (_e3 = "\n".concat(r).concat(n)), (o = new Error("Command failed: ".concat(c).concat(_e3))).code = i < 0 ? p(i) : i;
    }
  ...
  e.exports = function (e, t, n) {
    ...
    var P = new Promise(function (e) {
      ...
      }), h.stdin && h.stdin.on("error", function (t) {
        S(), e({
          error: t
        });
      });
    ...
    var E = function E() {
      return l(Promise.all([P, y(h, "stdout", {
        encoding: s,
        buffer: a,
        maxBuffer: u
      }), y(h, "stderr", {
        ...
        if (t.stdout = e[1], t.stderr = e[2], t.error || 0 !== t.code || null !== t.signal) {
          ...
          if (_e4.killed = _e4.killed || h.killed, !r.opts.reject) return _e4;
          throw _e4;
        }
    ...
    }(h, r.opts.input), h.then = function (e, t) {
      return E().then(e, t);
    }, h["catch"] = function (e) {
      return E()["catch"](e);
    }, h;
  }, e.exports.stdout = function () {
    return e.exports.apply(e, arguments).then(function (e) {
      return e.stdout;
    });
  ...
  var r = n(0),
      ...
      p = o(function () {
    return c.satisfies(process.version, "^4.8.0 || ^5.7.0 || >= 6.0.0", !0);
  }) || !1;
  ...
  function h(e) {
    ...
    if (e.options.forceShell || n) {
      ...
      e.command = r.normalize(e.command), e.command = s.command(e.command), e.args = e.args.map(function (e) {
        return s.argument(e, _n3);
      });

      var _o = [e.command].concat(e.args).join(" ");

      e.args = ["/d", "/s", "/c", "\"".concat(_o, "\"")], e.command = process.env.comspec || "cmd.exe", e.options.windowsVerbatimArguments = !0;
    }
  ...
  e.exports = function (e, t, n) {
    ...
    return n.shell ? function (e) {
      if (p) return e;
      var t = [e.command].concat(e.args).join(" ");
      return u ? (e.command = "string" == typeof e.options.shell ? e.options.shell : process.env.comspec || "cmd.exe", e.args = ["/d", "/s", "/c", "\"".concat(t, "\"")], e.options.windowsVerbatimArguments = !0) : ("string" == typeof e.options.shell ? e.command = e.options.shell : "android" === process.platform ? e.command = "/system/bin/sh" : e.command = "/bin/sh", e.args = ["-c", t]), e;
    }(r) : h(r);
  };
}, function (e, t, n) {
  "use strict";
  ...
  e.exports.command = function (e) {
    ...
    return e = (e = "\"".concat(e = (e = (e = "".concat(e)).replace(/(\\*)"/g, '$1$1\\"')).replace(/(\\*)$/, "$1$1"), "\"")).replace(r, "^$1"), t && (e = e.replace(r, "^$1")), e;
  };
}, function (e, t, n) {
  "use strict";
  ...
  var n;
  t = e.exports = Y, n = "object" == (typeof process === "undefined" ? "undefined" : _typeof(process)) && process.env && process.env.NODE_DEBUG && /\bsemver\b/i.test(process.env.NODE_DEBUG) ? function () {
  ...
  for (var q = 0; q < 35; q++) {
    n(q, s[q]), i[q] || (i[q] = new RegExp(s[q]));
  }
  ...
  function re(e, t, n, r) {
    ...
    switch (t) {
      case "===":
        "object" == _typeof(e) && (e = e.version), "object" == _typeof(n) && (n = n.version), o = e === n;
        break;
      ...
      return function (e, t) {
        return n("comp", e, t), e = function (e, t) {
          return e.trim().split(/\s+/).map(function (e) {
            return function (e, t) {
              n("caret", e, t), t && "object" == _typeof(t) || (t = {
                loose: !!t,
                includePrerelease: !1
              });
  ...
  function o(e, t) {
    return Object.assign(new Error("".concat(t, " ").concat(e.command, " ENOENT")), {
      code: "ENOENT",
      errno: "ENOENT",
      syscall: "".concat(t, " ").concat(e.command),
      path: e.command,
      spawnargs: e.args
    });
  }
    ...
    hookChildProcess: function hookChildProcess(e, t) {
      ...
      e.emit = function (r, o) {
        if ("exit" === r) {
          ...
          if (_r) return n.call(e, "error", _r);
        }
  ...
  e.exports = function (e) {
    ...
    var n = r.resolve(e.cwd);
    var i = [];

    for (; t !== n;) {
      i.push(r.join(n, "node_modules/.bin")), t = n, n = r.resolve(n, "..");
    }

    return i.push(r.dirname(process.execPath)), i.concat(e.path).join(r.delimiter);
  }, e.exports.env = function (t) {
    t = Object.assign({
      env: process.env
    }, t);
    var n = Object.assign({}, t.env),
        r = o({
      env: n
    });
  ...
  var r = e.exports = function (e) {
    return null !== e && "object" == _typeof(e) && "function" == typeof e.pipe;
  };

  r.writable = function (e) {
    return r(e) && !1 !== e.writable && "function" == typeof e._write && "object" == _typeof(e._writableState);
  }, r.readable = function (e) {
    return r(e) && !1 !== e.readable && "function" == typeof e._read && "object" == _typeof(e._readableState);
  }, r.duplex = function (e) {
    return r.writable(e) && r.readable(e);
  }, r.transform = function (e) {
    return r.duplex(e) && "function" == typeof e._transform && "object" == _typeof(e._transformState);
  };
}, function (e, t, n) {
  "use strict";
  ...
  function (_Error) {
    ...
    function i() {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(i).call(this, "maxBuffer exceeded")), _this.name = "MaxBufferError";
      return _this;
    }
  ...
  e.exports = s, e.exports.buffer = function (e, t) {
    return s(e, Object.assign({}, t, {
      encoding: "buffer"
    }));
  ...
  var r = n(31),
    ...
    return function (t) {
      ...
      }(e) ? e.abort() : c(e.destroy) ? e.destroy() : void _u(t || new Error("stream was destroyed"));
    };
  },
      l = function l(e) {
    e();
  ...
  e.exports = function (e) {
    ...
    return n && c.setEncoding(n), c.on("data", function (e) {
      a.push(e), i ? s = a.length : s += e.length;
    }), c.getBufferedValue = function () {
      return t ? a : o ? Buffer.concat(a, s) : a.join("");
    }, c.getBufferedLength = function () {
      return s;
    }, c;
  };
}, function (e, t) {
  ...
  e.exports = function (e, t) {
    return t = t || function () {}, e.then(function (e) {
  ...
  "function" != typeof s && (s = s.EventEmitter), process.__signal_exit_emitter__ ? r = process.__signal_exit_emitter__ : ((r = process.__signal_exit_emitter__ = new s()).count = 0, r.emitted = {}), r.infinite || (r.setMaxListeners(1 / 0), r.infinite = !0), e.exports = function (e, t) {
    o.equal(_typeof(e), "function", "a callback must be provided for exit handler"), !1 === l && f();
    var n = "exit";
  ...
  function i(e, t) {
    ...
    return "Unknown system error ".concat(t);
  }
  ...
  e.exports = function (e) {
    if (!e) return null;
    if (e.stdio && function (e) {
      return r.some(function (t) {
        return Boolean(e[t]);
      });
    }(e)) throw new Error("It's not possible to provide `stdio` in combination with one of ".concat(r.map(function (e) {
      return "`".concat(e, "`");
    }).join(", ")));
    if ("string" == typeof e.stdio) return e.stdio;
    var t = e.stdio || [];
    if (!Array.isArray(t)) throw new TypeError("Expected `stdio` to be of type `string` or `Array`, got `".concat(_typeof(t), "`"));
    var n = [],
        o = Math.max(t.length, r.length);

    for (var i = 0; i < o; i++) {
      var _o2 = null;
      void 0 !== t[i] ? _o2 = t[i] : void 0 !== e[r[i]] && (_o2 = e[r[i]]), n[i] = _o2;
    }
  ...
  var r = n(1);
  e.exports = {
    getBazelInfo: function getBazelInfo() {
    ...
    getClangInfo: function getClangInfo() {
    ...
    getMercurialInfo: function getMercurialInfo() {
    ...
    getSubversionInfo: function getSubversionInfo() {
    ...
    getFFmpegInfo: function getFFmpegInfo() {
  ...
  function i(e, t) {
    return o.log("trace", "clean", e), Object.keys(e).reduce(function (n, r) {
      ...
      }) ? n : Object.assign(n, _defineProperty({}, r, i(e[r], t))) : Object.assign(n, _defineProperty({}, r, e[r]));
    }, {});
  }
  ...
  function s(e, t) {
    ...
    return e.slice().split("\n").map(function (e) {
      if (":" === e.slice("-1")) {
        var r = e.match(/^[\s]*/g)[0];
        return "".concat(r).concat(n[t.type][0]).concat(e.slice(r.length)).concat(n[t.type][1]);
      }
  ...
  function a(e) {
    return o.log("trace", "formatPackages"), e.npmPackages ? Object.assign(e, {
      npmPackages: Object.entries(e.npmPackages || {}).reduce(function (e, t) {
        var n = t[0],
            r = t[1];
        if ("Not Found" === r) return Object.assign(e, _defineProperty({}, n, r));
        var o = r.wanted ? "".concat(r.wanted, " =>") : "",
            i = Array.isArray(r.installed) ? r.installed.join(", ") : r.installed,
            s = r.duplicates ? "(".concat(r.duplicates.join(", "), ")") : "";
        return Object.assign(e, _defineProperty({}, n, "".concat(o, " ").concat(i, " ").concat(s)));
      }, {})
    }) : e;
  }
  ...
  function c(e, t, n) {
    return n || (n = {
      emptyMessage: "None"
    }), Array.isArray(t) && (t = t.length > 0 ? t.join(", ") : n.emptyMessage), _defineProperty({}, e, t);
  }
  ...
  function u(e) {
    return o.log("trace", "serializeArrays"), function e(t, n) {
      return Object.entries(t).reduce(function (t, r) {
        var i = r[0],
            s = r[1];
        return o.isObject(s) ? Object.assign(t, _defineProperty({}, i, e(s, n))) : Object.assign(t, n(i, s));
      }, {});
    }(e, c);
  }
  ...
  function l(e) {
    return o.log("trace", "serializeVersionsAndPaths"), Object.entries(e).reduce(function (e, t) {
      return Object.assign(e, _defineProperty({}, t[0], Object.entries(t[1]).reduce(function (e, t) {
        var n = t[0],
            r = t[1];
        return r.version ? Object.assign(e, _defineProperty({}, n, [r.version, r.path].filter(Boolean).join(" - "))) : Object.assign(e, _defineProperty({}, n, [r][0]));
      }, {})), {});
    }, {});
  }
  ...
  function p(e) {
    return e.slice().split("\n").map(function (e) {
      if ("" !== e) {
        var t = ":" === e.slice("-1"),
            n = e.search(/\S|$/);
        return t ? "".concat("#".repeat(n / 2 + 1), " ") + e.slice(n) : " - " + e.slice(n);
      }
  ...
  e.exports = {
    json: function json(e, t) {
      return o.log("trace", "formatToJson"), t || (t = {}), e = o.pipe([function () {
        ...
        return _defineProperty({}, t.title, e);
      } : o.noop, h])(e), e = t.console ? "\n".concat(e, "\n") : e;
    },
    markdown: function markdown(e, t) {
  ...
  e.exports = function (e, t) {
    ...
    function d(e) {
      ...
      return Object.keys(e).forEach(function (c) {
        ...
        o += "".concat(f).concat(a).concat(c, ":").concat(p).concat(h, "\n");
    ...
    var y = "";
    return h.set(e), "object" === r(e) && Object.keys(e).length > 0 ? y = d(e) : "array" === r(e) && e.length > 0 && (y = m(e)), 0 === y.length ? "" : "".concat(c).concat(y.slice(1)).concat(u);
  };
}, function (e, t, n) {
  "use strict";

  e.exports = function (e) {
    return Array.isArray(e) ? "array" : e instanceof Date ? "date" : e instanceof Error ? "error" : null === e ? "null" : "object" == _typeof(e) && "[object Object]" === Object.prototype.toString.call(e) ? "object" : _typeof(e);
  };
}, function (e, t, n) {
  "use strict";
  ...
  e.exports = function (e) {
    return "new Date(".concat(Date.prototype.toISOString.call(e), ")");
  };
}, function (e, t, n) {
  "use strict";
  ...
  e.exports = function () {
    for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1, t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "  ", n = "", r = 0; r < e; r += 1) {
      n += t;
    }
