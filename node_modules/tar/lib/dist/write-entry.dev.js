...
function (_MiniPass2) {
  ...
  function WriteEntryTar(readEntry, opt) {
    ...
    if (_this6.header.encode() && !_this6.noPax) _get(_getPrototypeOf(WriteEntryTar.prototype), "write", _assertThisInitialized(_this6)).call(_assertThisInitialized(_this6), new Pax({
      atime: _this6.portable ? null : _this6.atime,
      ctime: _this6.portable ? null : _this6.ctime,
      gid: _this6.portable ? null : _this6.gid,
      mtime: _this6.noMtime ? null : _this6.mtime,
    ...
    _get(_getPrototypeOf(WriteEntryTar.prototype), "write", _assertThisInitialized(_this6)).call(_assertThisInitialized(_this6), _this6.header.block);

    readEntry.pipe(_assertThisInitialized(_this6));
    return _this6;
  }
